parcelRequire = function (e, r, t, n) {
    ...
    "JZPE": [function (require, module, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", {value: !0}), exports.expose = c, exports.proxy = v, exports.transfer = h, exports.windowEndpoint = x, exports.wrap = l, exports.transferHandlers = exports.releaseProxy = exports.proxyMarker = exports.createEndpoint = void 0;
        ...
        const r = Symbol("Comlink.thrown"), a = e => "object" == typeof e && null !== e || "function" == typeof e, s = {
            canHandle: t => a(t) && t[e], serialize(e) {
                const {port1: t, port2: n} = new MessageChannel;
                return c(e, t), [n, [n]]
            }, deserialize: e => (e.start(), l(e))
        }, o = {
            canHandle: e => a(e) && r in e, serialize({value: e}) {
                let t;
        ...
        function c(e, t = self) {
            t.addEventListener("message", function n(a) {
                if (!a || !a.data) return;
                const {id: s, type: o, path: i} = Object.assign({path: []}, a.data),
                    p = (a.data.argumentList || []).map(w);
                let l;
                try {
                    const t = i.slice(0, -1).reduce((e, t) => e[t], e), n = i.reduce((e, t) => e[t], e);
                    switch (o) {
                        case 0:
                            l = n;
                            break;
                ...
                Promise.resolve(l).catch(e => ({value: e, [r]: 0})).then(e => {
                    const [r, a] = b(e);
                    t.postMessage(Object.assign(Object.assign({}, r), {id: s}), a), 5 === o && (t.removeEventListener("message", n), u(t))
                })
            }), t.start && t.start()
        }
        ...
        function f(e, r = [], a = function () {
            ...
            const o = new Proxy(a, {
                get(t, a) {
                    if (d(s), a === n) return () => E(e, {type: 5, path: r.map(e => e.toString())}).then(() => {
                        u(e), s = !0
                    });
                    if ("then" === a) {
                        if (0 === r.length) return {then: () => o};
                        const t = E(e, {type: 0, path: r.map(e => e.toString())}).then(w);
                    ...
                    d(s);
                    const [o, i] = b(a);
                    return E(e, {type: 1, path: [...r, n].map(e => e.toString()), value: o}, i).then(w)
                }, apply(n, a, o) {
                    d(s);
                    const i = r[r.length - 1];
                    if (i === t) return E(e, {type: 4}).then(w);
                    if ("bind" === i) return f(e, r.slice(0, -1));
                    const [c, p] = g(o);
                    return E(e, {type: 2, path: r.map(e => e.toString()), argumentList: c}, p).then(w)
                }, construct(t, n) {
                    d(s);
                    const [a, o] = g(n);
                    return E(e, {type: 3, path: r.map(e => e.toString()), argumentList: a}, o).then(w)
                }
            });
            return o
        }
        ...
        function E(e, t, n) {
            return new Promise(r => {
                ...
                }), e.start && e.start(), e.postMessage(Object.assign({id: a}, t), n)
            })
        }
    ...
    "xsoH": [function (require, module, exports) {
        "use strict";
    ...
    "c8rS": [function (require, module, exports) {
    ...
    "MGww": [function (require, module, exports) {
        var r = {}.toString;
        module.exports = Array.isArray || function (t) {
            return "[object Array]" == r.call(t)
        };
    }, {}],
    "MMtH": [function (require, module, exports) {
    ...
    }, {"base64-js": "xsoH", "ieee754": "c8rS", "isarray": "MGww", "buffer": "MMtH"}],
    "cZJc": [function (require, module, exports) {
    ...
    "JNDr": [function (require, module, exports) {
    ...
    "yWlW": [function (require, module, exports) {

        var global = arguments[3];
        var process = require("process");
        var e = arguments[3], r = require("process"), o = 65536, n = 4294967295;

        function t() {
            throw new Error("Secure random number generation is not supported by this browser.\nUse Chrome, Firefox or Internet Explorer 11")
        }

        var s = require("safe-buffer").Buffer, u = e.crypto || e.msCrypto;

        function a(e, t) {
            if (e > n) throw new RangeError("requested too many random bytes");
            var a = s.allocUnsafe(e);
            if (e > 0) if (e > o) for (var f = 0; f < e; f += o) u.getRandomValues(a.slice(f, f + o)); else u.getRandomValues(a);
    ...
    }, {"safe-buffer": "cZJc", "process": "JNDr"}],
    "YJEE": [function (require, module, exports) {
    ...
    "r4oP": [function (require, module, exports) {
        "use strict";
        ...
        function a(e, t, n) {
            var r = {fired: !1, wrapFn: void 0, target: e, type: t, listener: n}, i = l.bind(r);
    ...
    "dSTB": [function (require, module, exports) {
        var process = require("process");
        ...
        void 0 === n || !n.version || 0 === n.version.indexOf("v0.") || 0 === n.version.indexOf("v1.") && 0 !== n.version.indexOf("v1.8.") ? module.exports = {nextTick: e} : module.exports = n;
    }, {"process": "JNDr"}],
    "aZ3V": [function (require, module, exports) {
        module.exports = require("events").EventEmitter;
    }, {"events": "r4oP"}],
    "Mhpb": [function (require, module, exports) {
    ...
    "p2tE": [function (require, module, exports) {

    }, {}],
    "kZY1": [function (require, module, exports) {
    ...
    }, {"safe-buffer": "cZJc", "util": "p2tE"}],
    "m5aE": [function (require, module, exports) {
        "use strict";
    ...
    }, {"process-nextick-args": "dSTB"}],
    "MeXw": [function (require, module, exports) {
        var global = arguments[3];
        var r = arguments[3];
    ...
    "MhnJ": [function (require, module, exports) {
        var process = require("process");
        ...
        "inherits": "YJEE",
        "util-deprecate": "MeXw",
        "./internal/streams/stream": "aZ3V",
        "safe-buffer": "cZJc",
        "./internal/streams/destroy": "m5aE",
        "./_stream_duplex": "Z5FG",
        "process": "JNDr"
    }],
    "Z5FG": [function (require, module, exports) {
        "use strict";
        ...
        "core-util-is": "Mhpb",
        "inherits": "YJEE",
        "./_stream_readable": "mh09",
        "./_stream_writable": "MhnJ"
    }],
    "Etb4": [function (require, module, exports) {
    ...
    "mh09": [function (require, module, exports) {
        ...
        "inherits": "YJEE",
        "util": "p2tE",
        "./internal/streams/BufferList": "kZY1",
        "./internal/streams/destroy": "m5aE",
        "./_stream_duplex": "Z5FG",
        "string_decoder/": "Etb4",
        "process": "JNDr"
    }],
    "pZxu": [function (require, module, exports) {
        "use strict";
        module.exports = n;
    ...
    }, {"./_stream_duplex": "Z5FG", "core-util-is": "Mhpb", "inherits": "YJEE"}],
    "CLCI": [function (require, module, exports) {
        "use strict";
        module.exports = t;
    ...
    }, {"./_stream_transform": "pZxu", "core-util-is": "Mhpb", "inherits": "YJEE"}],
    "A8to": [function (require, module, exports) {
        exports = module.exports = require("./lib/_stream_readable.js"), exports.Stream = exports, exports.Readable = exports, exports.Writable = require("./lib/_stream_writable.js"), exports.Duplex = require("./lib/_stream_duplex.js"), exports.Transform = require("./lib/_stream_transform.js"), exports.PassThrough = require("./lib/_stream_passthrough.js");
    }, {
        "./lib/_stream_readable.js": "mh09",
        "./lib/_stream_writable.js": "MhnJ",
        "./lib/_stream_duplex.js": "Z5FG",
        "./lib/_stream_transform.js": "pZxu",
        "./lib/_stream_passthrough.js": "CLCI"
    }],
    "WZFZ": [function (require, module, exports) {
        module.exports = require("./lib/_stream_writable.js");
    }, {"./lib/_stream_writable.js": "MhnJ"}],
    "JIEI": [function (require, module, exports) {
        module.exports = require("./lib/_stream_duplex.js");
    }, {"./lib/_stream_duplex.js": "Z5FG"}],
    "MnUX": [function (require, module, exports) {
        module.exports = require("./readable").Transform;
    }, {"./readable": "A8to"}],
    "wt1Z": [function (require, module, exports) {
        module.exports = require("./readable").PassThrough;
    }, {"./readable": "A8to"}],
    "Gy6E": [function (require, module, exports) {
        module.exports = n;
        ...
        "events": "r4oP",
        "inherits": "YJEE",
        "readable-stream/readable.js": "A8to",
        "readable-stream/writable.js": "WZFZ",
        "readable-stream/duplex.js": "JIEI",
        "readable-stream/transform.js": "MnUX",
        "readable-stream/passthrough.js": "wt1Z"
    }],
    "CQ5P": [function (require, module, exports) {

        "use strict";
        var t = require("safe-buffer").Buffer, e = require("stream").Transform, i = require("inherits");
    ...
    }, {"safe-buffer": "cZJc", "stream": "Gy6E", "inherits": "YJEE"}],
    "SfRQ": [function (require, module, exports) {

        "use strict";
        var t = require("inherits"), i = require("hash-base"), s = require("safe-buffer").Buffer, e = new Array(16);
        ...
        t(h, i), h.prototype._update = function () {
            ...
            var s = this._a, h = this._b, r = this._c, o = this._d;
    ...
    }, {"inherits": "YJEE", "hash-base": "CQ5P", "safe-buffer": "cZJc"}],
    "UBv1": [function (require, module, exports) {

        "use strict";
        var t = require("buffer").Buffer, i = require("inherits"), s = require("hash-base"), h = new Array(16),
    ...
    }, {"buffer": "MMtH", "inherits": "YJEE", "hash-base": "CQ5P"}],
    "xoqU": [function (require, module, exports) {
        ...
        i.prototype.update = function (i, e) {
            ...
            if (e <= 4294967295) this._block.writeUInt32BE(e, this._blockSize - 4); else {
                var s = (4294967295 & e) >>> 0, o = (e - s) / 4294967296;
    ...
    "mGnq": [function (require, module, exports) {

        var t = require("inherits"), i = require("./hash"), r = require("safe-buffer").Buffer,
            s = [1518500249, 1859775393, -1894007588, -899497514], h = new Array(80);
        ...
        t(e, i), e.prototype.init = function () {
            ...
            for (var c = 0; c < 80; ++c) {
                var d = ~~(c / 20), p = n(r) + a(d, h, e, o) + u + i[c] + s[d] | 0;
    ...
    }, {"inherits": "YJEE", "./hash": "xoqU", "safe-buffer": "cZJc"}],
    "Q7dB": [function (require, module, exports) {

        var t = require("inherits"), i = require("./hash"), r = require("safe-buffer").Buffer,
            s = [1518500249, 1859775393, -1894007588, -899497514], e = new Array(80);
        ...
        t(h, i), h.prototype.init = function () {
            ...
            for (var d = 0; d < 80; ++d) {
                var p = ~~(d / 20), w = _(r) + o(p, e, h, a) + f + i[d] + s[p] | 0;
    ...
    "Z9qb": [function (require, module, exports) {

        var t = require("inherits"), i = require("./hash"), h = require("safe-buffer").Buffer,
        ...
        t(_, i), _.prototype.init = function () {
            ...
            for (var p = 0; p < 64; ++p) {
                var b = I + f(w) + n(w, B, E) + s[p] + i[p] | 0, g = u(h) + e(h, r, _) | 0;
    ...
    "dBlf": [function (require, module, exports) {

        var t = require("inherits"), i = require("./sha256"), e = require("./hash"), r = require("safe-buffer").Buffer,
            h = new Array(64);
    ...
    }, {"inherits": "YJEE", "./sha256": "Z9qb", "./hash": "xoqU", "safe-buffer": "cZJc"}],
    "AHy7": [function (require, module, exports) {

        var h = require("inherits"), t = require("./hash"), i = require("safe-buffer").Buffer,
        ...
        h(l, t), l.prototype.init = function () {
            ...
            for (; U < 160; U += 2) {
                var j = t[U - 30], k = t[U - 30 + 1], z = u(j, k), C = a(k, j), D = c(j = t[U - 4], k = t[U - 4 + 1]),
                    F = o(k, j), G = t[U - 14], H = t[U - 14 + 1], J = t[U - 32], K = t[U - 32 + 1], L = C + H | 0,
                    M = z + G + d(L, C) | 0;
                M = (M = M + D + d(L = L + F | 0, F) | 0) + J + d(L = L + K | 0, K) | 0, t[U] = M, t[U + 1] = L
            }
            for (var N = 0; N < 160; N += 2) {
                M = t[N], L = t[N + 1];
                var O = n(i, _, l), P = n(B, y, E), Q = e(i, B), R = e(B, i), S = f(g, q), T = f(q, g), V = s[N],
                    W = s[N + 1], X = r(g, p, v), Y = r(q, m, x), Z = A + T | 0, $ = w + S + d(Z, A) | 0;
                $ = ($ = ($ = $ + X + d(Z = Z + Y | 0, Y) | 0) + V + d(Z = Z + W | 0, W) | 0) + M + d(Z = Z + L | 0, L) | 0;
                var hh = R + P | 0, th = Q + O + d(hh, R) | 0;
    ...
    "DZ9z": [function (require, module, exports) {

        var h = require("inherits"), t = require("./sha512"), i = require("./hash"), s = require("safe-buffer").Buffer,
            _ = new Array(160);
    ...
    }, {"inherits": "YJEE", "./sha512": "AHy7", "./hash": "xoqU", "safe-buffer": "cZJc"}],
    "gJ8a": [function (require, module, exports) {
    ...
    "Mqra": [function (require, module, exports) {

        var t = require("safe-buffer").Buffer, i = require("stream").Transform,
            r = require("string_decoder").StringDecoder, e = require("inherits");
    ...
    }, {"safe-buffer": "cZJc", "stream": "Gy6E", "string_decoder": "Etb4", "inherits": "YJEE"}],
    "uodg": [function (require, module, exports) {
        "use strict";
        var e = require("inherits"), r = require("md5.js"), t = require("ripemd160"), i = require("sha.js"),
    ...
    }, {"inherits": "YJEE", "md5.js": "SfRQ", "ripemd160": "UBv1", "sha.js": "gJ8a", "cipher-base": "Mqra"}],
    "iHcI": [function (require, module, exports) {

        "use strict";
        var t = require("inherits"), e = require("safe-buffer").Buffer, a = require("cipher-base"), i = e.alloc(128),
            s = 64;
    ...
    }, {"inherits": "YJEE", "safe-buffer": "cZJc", "cipher-base": "Mqra"}],
    "O234": [function (require, module, exports) {
        var e = require("md5.js");
        module.exports = function (r) {
            return (new e).update(r).digest()
        };
    }, {"md5.js": "SfRQ"}],
    "R8He": [function (require, module, exports) {

        "use strict";
        var e = require("inherits"), t = require("./legacy"), r = require("cipher-base"),
            a = require("safe-buffer").Buffer, i = require("create-hash/md5"), s = require("ripemd160"),
            h = require("sha.js"), n = a.alloc(128);
        ...
        "cipher-base": "Mqra",
        "safe-buffer": "cZJc",
        "create-hash/md5": "O234",
        "ripemd160": "UBv1",
        "sha.js": "gJ8a"
    }],
    "hTYa": [function (require, module, exports) {
        module.exports = {
    ...
    "IYru": [function (require, module, exports) {
        module.exports = require("./browser/algorithms.json");
    }, {"./browser/algorithms.json": "hTYa"}],
    "sNQ0": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var r = require("buffer").Buffer, e = Math.pow(2, 30) - 1;
    ...
    "yAKP": [function (require, module, exports) {

        var e = require("create-hash/md5"), r = require("ripemd160"), a = require("sha.js"),
            i = require("./precondition"), t = require("./default-encoding"), s = require("safe-buffer").Buffer,
            n = s.alloc(128),
            h = {md5: 16, sha1: 20, sha224: 28, sha256: 32, sha384: 48, sha512: 64, rmd160: 20, ripemd160: 20};

        function o(e, r, a) {
            var i = u(e), t = "sha512" === e || "sha384" === e ? 128 : 64;
            r.length > t ? r = i(r) : r.length < t && (r = s.concat([r, n], t));
            for (var o = s.allocUnsafe(t + h[e]), f = s.allocUnsafe(t + h[e]), c = 0; c < t; c++) o[c] = 54 ^ r[c], f[c] = 92 ^ r[c];
            var l = s.allocUnsafe(t + a + 4);
            o.copy(l, 0, 0, t), this.ipad1 = l, this.ipad2 = o, this.opad = f, this.alg = e, this.blocksize = t, this.hash = i, this.size = h[e]
        }

        function u(i) {
            return "rmd160" === i || "ripemd160" === i ? function (e) {
        ...
        function f(e, r, a, n, u) {
            i(e, r, a, n), s.isBuffer(e) || (e = s.from(e, t)), s.isBuffer(r) || (r = s.from(r, t));
            var f = new o(u = u || "sha1", e, r.length), c = s.allocUnsafe(n), l = s.allocUnsafe(r.length + 4);
            r.copy(l, 0, 0, r.length);
            for (var d = 0, p = h[u], m = Math.ceil(n / p), g = 1; g <= m; g++) {
        ...
        "sha.js": "gJ8a",
        "./precondition": "sNQ0",
        "./default-encoding": "nyUk",
        "safe-buffer": "cZJc"
    }],
    "lbjX": [function (require, module, exports) {

        var global = arguments[3];
        var process = require("process");
        var r, e = arguments[3], n = require("process"), t = require("./precondition"),
            o = require("./default-encoding"), i = require("./sync"), u = require("safe-buffer").Buffer,
            f = e.crypto && e.crypto.subtle, s = {
                sha: "SHA-1",
                "sha-1": "SHA-1",
                sha1: "SHA-1",
                sha256: "SHA-256",
        ...
        function h(r, e, n, t, o) {
            return f.importKey("raw", r, {name: "PBKDF2"}, !1, ["deriveBits"]).then(function (r) {
                return f.deriveBits({name: "PBKDF2", salt: e, iterations: n, hash: {name: o}}, r, t << 3)
            }).then(function (r) {
                return u.from(r)
            })
        }
    ...
    "mhox": [function (require, module, exports) {
        exports.pbkdf2 = require("./lib/async"), exports.pbkdf2Sync = require("./lib/sync");
    }, {"./lib/async": "lbjX", "./lib/sync": "yAKP"}],
    "PIdW": [function (require, module, exports) {
        "use strict";
        exports.readUInt32BE = function (r, o) {
            ...
            for (var n = 0, e = 0, u = 0; u < 4; u++) for (var i = 24; i >= 0; i -= 8) n <<= 1, n |= o >>> i + u & 1, n <<= 1, n |= r >>> i + u & 1;
            for (u = 4; u < 8; u++) for (i = 24; i >= 0; i -= 8) e <<= 1, e |= o >>> i + u & 1, e <<= 1, e |= r >>> i + u & 1;
            t[f + 0] = n >>> 0, t[f + 1] = e >>> 0
    ...
    "hGLJ": [function (require, module, exports) {
        function r(r, o) {
    ...
    "KyNd": [function (require, module, exports) {
        "use strict";
        ...
        module.exports = f, f.prototype._init = function () {
            ...
            var f = 0, e = 0, r = (this.bufferOff + t.length) / this.blockSize | 0, i = new Array(r * this.blockSize);
    ...
    }, {"minimalistic-assert": "hGLJ"}],
    "oh12": [function (require, module, exports) {
        "use strict";
        var t = require("minimalistic-assert"), e = require("inherits"), r = require("./utils"),
            n = require("./cipher");
        ...
        i.prototype.deriveKeys = function (e, n) {
            ...
            var p = r.readUInt32BE(n, 0), i = r.readUInt32BE(n, 4);
            ...
            var i = this._desState, s = r.readUInt32BE(t, e), a = r.readUInt32BE(t, e + 4);
            ...
            for (var s = e, a = n, u = 0; u < t.keys.length; u += 2) {
                var o = t.keys[u], y = t.keys[u + 1];
                r.expand(a, t.tmp, 0), o ^= t.tmp[0], y ^= t.tmp[1];
                var h = r.substitute(o, y), l = a;
            ...
            for (var s = n, a = e, u = t.keys.length - 2; u >= 0; u -= 2) {
                ...
                var h = r.substitute(o, y), l = s;
                s = (a ^ r.permute(h)) >>> 0, a = l
            }
            r.rip(s, a, p, i)
        };
    }, {"minimalistic-assert": "hGLJ", "inherits": "YJEE", "./utils": "PIdW", "./cipher": "KyNd"}],
    "oIc9": [function (require, module, exports) {
        "use strict";
        var t = require("minimalistic-assert"), i = require("inherits"), e = {};
        ...
        exports.instantiate = n, e._cbcInit = function () {
            ...
            var n = this._cbcState, s = this.constructor.super_.prototype, c = n.iv;
    ...
    }, {"minimalistic-assert": "hGLJ", "inherits": "YJEE"}],
    "AGOx": [function (require, module, exports) {
        "use strict";
        var e = require("minimalistic-assert"), t = require("inherits"), r = require("./cipher"), p = require("./des");

        function i(t, r) {
            e.equal(r.length, 24, "Invalid key length");
            var i = r.slice(0, 8), c = r.slice(8, 16), y = r.slice(16, 24);
            this.ciphers = "encrypt" === t ? [p.create({type: "encrypt", key: i}), p.create({
                type: "decrypt",
                key: c
            }), p.create({type: "encrypt", key: y})] : [p.create({type: "decrypt", key: y}), p.create({
                type: "encrypt",
                key: c
    ...
    }, {"minimalistic-assert": "hGLJ", "inherits": "YJEE", "./cipher": "KyNd", "./des": "oh12"}],
    "fpKW": [function (require, module, exports) {
        "use strict";
    ...
    }, {"./des/utils": "PIdW", "./des/cipher": "KyNd", "./des/des": "oh12", "./des/cbc": "oIc9", "./des/ede": "AGOx"}],
    "kcG1": [function (require, module, exports) {

        var e = require("cipher-base"), r = require("des.js"), t = require("inherits"),
            s = require("safe-buffer").Buffer, d = {
        ...
        function i(r) {
            e.call(this);
            var t, i = r.mode.toLowerCase(), c = d[i];
    ...
    }, {"cipher-base": "Mqra", "des.js": "fpKW", "inherits": "YJEE", "safe-buffer": "cZJc"}],
    "Sy4M": [function (require, module, exports) {
    ...
    "SbWE": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
    ...
    "Pivl": [function (require, module, exports) {
    ...
    "JwNP": [function (require, module, exports) {

        var e = require("safe-buffer").Buffer, c = require("buffer-xor");

        function r(r, a, n) {
            var t = a.length, h = c(a, r._cache);
    ...
    }, {"safe-buffer": "cZJc", "buffer-xor": "SbWE"}],
    "ejyt": [function (require, module, exports) {
    ...
    "xNRU": [function (require, module, exports) {
        ...
        function n(e, n) {
            var f = e.length, t = -1, o = r.allocUnsafe(e.length);
    ...
    "NDX0": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var e = require("buffer").Buffer, c = require("buffer-xor");
    ...
    }, {"buffer-xor": "SbWE", "buffer": "MMtH"}],
    "UDtX": [function (require, module, exports) {
        function t(t) {
    ...
    "itqO": [function (require, module, exports) {

        var e = require("buffer-xor"), c = require("safe-buffer").Buffer, r = require("../incr32");
        ...
        exports.encrypt = function (r, n) {
            var h = Math.ceil(n.length / t), i = r._cache.length;
    ...
    }, {"buffer-xor": "SbWE", "safe-buffer": "cZJc", "../incr32": "UDtX"}],
    "I4cz": [function (require, module, exports) {
        module.exports = {
    ...
    "OpMi": [function (require, module, exports) {
        ...
        var o = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], i = function () {
            ...
            for (var r = [], n = [], o = [[], [], [], []], i = [[], [], [], []], B = 0, S = 0, u = 0; u < 256; ++u) {
                ...
                var _ = e[B], f = e[_], a = e[f], s = 257 * e[c] ^ 16843008 * c;
        ...
        B.blockSize = 16, B.keySize = 32, B.prototype.blockSize = B.blockSize, B.prototype.keySize = B.keySize, B.prototype._reset = function () {
            ...
            var r = this.encryptBlockRaw(t), n = e.allocUnsafe(16);
            ...
            var o = (r = t(r))[1];
            r[1] = r[3], r[3] = o;
            var B = n(r, this._invKeySchedule, i.INV_SUB_MIX, i.INV_SBOX, this._nRounds), S = e.allocUnsafe(16);
    ...
    "c6LL": [function (require, module, exports) {

        var t = require("safe-buffer").Buffer, e = t.alloc(16, 0);
    ...
    "IpdI": [function (require, module, exports) {

        var t = require("./aes"), e = require("safe-buffer").Buffer, r = require("cipher-base"),
            h = require("inherits"), a = require("./ghash"), i = require("buffer-xor"), n = require("./incr32");
    ...
    "h8TH": [function (require, module, exports) {

        var e = require("./aes"), r = require("safe-buffer").Buffer, t = require("cipher-base"),
            i = require("inherits");
    ...
    }, {"./aes": "OpMi", "safe-buffer": "cZJc", "cipher-base": "Mqra", "inherits": "YJEE"}],
    "vGPV": [function (require, module, exports) {

        var e = require("safe-buffer").Buffer, r = require("md5.js");
        ...
        function t(t, a, f, l) {
            ...
            for (var n = f / 8, i = e.alloc(n), o = e.alloc(l || 0), u = e.alloc(0); n > 0 || l > 0;) {
                ...
                if (g < u.length && l > 0) {
                    var d = o.length - l, v = Math.min(l, u.length - g);
        ...
        module.exports = t;
    }, {"safe-buffer": "cZJc", "md5.js": "SfRQ"}],
    "xF0A": [function (require, module, exports) {

        var e = require("./modes"), t = require("./authCipher"), r = require("safe-buffer").Buffer,
            i = require("./streamCipher"), n = require("cipher-base"), h = require("./aes"),
            o = require("evp_bytestokey"), a = require("inherits");
    ...
    "ikAJ": [function (require, module, exports) {

        var e = require("./authCipher"), t = require("safe-buffer").Buffer, r = require("./modes"),
            i = require("./streamCipher"), h = require("cipher-base"), n = require("./aes"),
            o = require("evp_bytestokey"), a = require("inherits");
    ...
    "bDOc": [function (require, module, exports) {
        var e = require("./encrypter"), r = require("./decrypter"), i = require("./modes/list.json");
    ...
    }, {"./encrypter": "xF0A", "./decrypter": "ikAJ", "./modes/list.json": "I4cz"}],
    "Qe2z": [function (require, module, exports) {
        exports["des-ecb"] = {key: 8, iv: 0}, exports["des-cbc"] = exports.des = {
            key: 8,
            iv: 8
        }, exports["des-ede3-cbc"] = exports.des3 = {key: 24, iv: 8}, exports["des-ede3"] = {
            key: 24,
            iv: 0
        }, exports["des-ede-cbc"] = {key: 16, iv: 8}, exports["des-ede"] = {key: 16, iv: 0};
    }, {}],
    "XOFb": [function (require, module, exports) {
        var e = require("browserify-des"), r = require("browserify-aes/browser"), i = require("browserify-aes/modes"),
            t = require("browserify-des/modes"), o = require("evp_bytestokey");

        function s(e, r) {
            var s, p;
            if (e = e.toLowerCase(), i[e]) s = i[e].key, p = i[e].iv; else {
        ...
        "browserify-des": "kcG1",
        "browserify-aes/browser": "bDOc",
        "browserify-aes/modes": "T8hP",
        "browserify-des/modes": "Qe2z",
        "evp_bytestokey": "vGPV"
    }],
    "a1T6": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        ...
        !function (t, i) {
            ...
            n.isBN = function (t) {
                ...
                var e, o, s = 0;
                if ("be" === h) for (n = t.length - 1, e = 0; n >= 0; n -= 3) o = t[n] | t[n - 1] << 8 | t[n - 2] << 16, this.words[e] |= o << s & 67108863, this.words[e + 1] = o >>> 26 - s & 67108863, (s += 24) >= 26 && (s -= 26, e++); else if ("le" === h) for (n = 0, e = 0; n < t.length; n += 3) o = t[n] | t[n + 1] << 8 | t[n + 2] << 16, this.words[e] |= o << s & 67108863, this.words[e + 1] = o >>> 26 - s & 67108863, (s += 24) >= 26 && (s -= 26, e++);
                return this.strip()
            ...
            n.prototype.toString = function (t, i) {
                ...
                if (i = 0 | i || 1, 16 === (t = t || 10) || "hex" === t) {
                    ...
                    for (var n = 0, e = 0, o = 0; o < this.length; o++) {
                        var s = this.words[o], m = (16777215 & (s << n | e)).toString(16);
                ...
                var n = this.byteLength(), e = h || Math.max(1, n);
            ...
            var f = function (t, i, r) {
                var h, n, e, o = t.words, s = i.words, u = r.words, a = 0, l = 0 | o[0], m = 8191 & l, f = l >>> 13,
                    d = 0 | o[1], p = 8191 & d, M = d >>> 13, v = 0 | o[2], g = 8191 & v, c = v >>> 13, w = 0 | o[3],
                    y = 8191 & w, b = w >>> 13, _ = 0 | o[4], k = 8191 & _, A = _ >>> 13, x = 0 | o[5], S = 8191 & x,
                    q = x >>> 13, Z = 0 | o[6], R = 8191 & Z, B = Z >>> 13, N = 0 | o[7], L = 8191 & N, I = N >>> 13,
                    z = 0 | o[8], T = 8191 & z, E = z >>> 13, O = 0 | o[9], j = 8191 & O, K = O >>> 13, P = 0 | s[0],
                    F = 8191 & P, C = P >>> 13, D = 0 | s[1], H = 8191 & D, J = D >>> 13, U = 0 | s[2], G = 8191 & U,
                    Q = U >>> 13, V = 0 | s[3], W = 8191 & V, X = V >>> 13, Y = 0 | s[4], $ = 8191 & Y, tt = Y >>> 13,
                    it = 0 | s[5], rt = 8191 & it, ht = it >>> 13, nt = 0 | s[6], et = 8191 & nt, ot = nt >>> 13,
                    st = 0 | s[7], ut = 8191 & st, at = st >>> 13, lt = 0 | s[8], mt = 8191 & lt, ft = lt >>> 13,
                    dt = 0 | s[9], pt = 8191 & dt, Mt = dt >>> 13;
            ...
            Math.imul || (f = m), n.prototype.mulTo = function (t, i) {
                ...
                for (var o = 1; o < n; o <<= 1) for (var s = o << 1, u = Math.cos(2 * Math.PI / s), a = Math.sin(2 * Math.PI / s), l = 0; l < n; l += s) for (var m = u, f = a, d = 0; d < o; d++) {
                ...
                var h = 2 * this.guessLen13b(t.length, i.length), n = this.makeRBT(h), e = this.stub(h),
                    o = new Array(h), s = new Array(h), u = new Array(h), a = new Array(h), l = new Array(h),
                    m = new Array(h), f = r.words;
                ...
                for (var i = 0, h = 0; h < this.length; h++) {
                    var n = (0 | this.words[h]) * t, e = (67108863 & n) + (67108863 & i);
                ...
                if (0 !== h) {
                    ...
                    for (i = 0; i < this.length; i++) {
                        var s = this.words[i] & e, u = (0 | this.words[i]) - s << h;
                ...
                var e = t % 26, o = Math.min((t - e) / 26, this.length), s = 67108863 ^ 67108863 >>> e << e, u = h;
                ...
                var r = (this.length, t.length), h = this.clone(), e = t, o = 0 | e.words[e.length - 1];
                ...
                return s && s.strip(), h.strip(), "div" !== i && 0 !== r && h.iushrn(r), {div: s || null, mod: h}
                ...
                } : {div: this.divn(t.words[0]), mod: new n(this.modn(t.words[0]))} : this._wordDiv(t, i);
                var e, o, s
                ...
                for (var l = h.clone(), m = i.clone(); !i.isZero();) {
                    ...
                    if (p > 0) for (h.iushrn(p); p-- > 0;) (s.isOdd() || u.isOdd()) && (s.iadd(l), u.isub(m)), s.iushrn(1), u.iushrn(1);
                ...
                for (var e, o = new n(1), s = new n(0), u = h.clone(); i.cmpn(1) > 0 && h.cmpn(1) > 0;) {
                    ...
                    if (m > 0) for (h.iushrn(m); m-- > 0;) s.isOdd() && s.iadd(u), s.iushrn(1);
                ...
                if (0 === this.negative && h) return 1;
                if (this.strip(), this.length > 1) i = 1; else {
                ...
                for (var i = 0, r = this.length - 1; r >= 0; r--) {
                    var h = 0 | this.words[r], n = 0 | t.words[r];
                    if (h !== n) {
                        h < n ? i = -1 : h > n && (i = 1);
                        break
                    }
            ...
            v.prototype._tmp = function () {
                ...
                if (M[t]) return M[t];
                var i;
                if ("k256" === t) i = new g; else if ("p224" === t) i = new c; else if ("p192" === t) i = new w; else {
                ...
                r(!e.isZero());
                var s = new n(1).toRed(this), u = s.redNeg(), a = this.m.subn(1).iushrn(1), l = this.m.bitLength();
                ...
                var e = r[0], o = 0, s = 0, u = i.bitLength() % 26;
                ...
                var r = t.imul(i), h = r.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m),
                    n = r.isub(h).iushrn(this.shift), e = n;
                ...
                var r = t.mul(i), h = r.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m),
                    e = r.isub(h).iushrn(this.shift), o = e;
    ...
    "h8aG": [function (require, module, exports) {
        var t;
    ...
    "JA6Y": [function (require, module, exports) {
        var r = require("bn.js"), e = require("brorand");
        ...
        module.exports = n, n.create = function (r) {
            ...
            var n = e.bitLength(), t = Math.ceil(n / 8);
            do {
            ...
            var o = e.bitLength(), a = r.mont(e), d = new r(1).toRed(a);
    ...
    }, {"bn.js": "a1T6", "brorand": "h8aG"}],
    "HqNM": [function (require, module, exports) {
        var e = require("randombytes");
        module.exports = M, M.simpleSieve = b, M.fermatTest = q;
        var n = require("bn.js"), r = new n(24), t = require("miller-rabin"), i = new t, o = new n(1), f = new n(2),
            a = new n(5), u = new n(16), w = new n(8), d = new n(10), m = new n(3), s = new n(7), c = new n(11),
            l = new n(4), v = new n(12), p = null;
    ...
    }, {"randombytes": "yWlW", "bn.js": "a1T6", "miller-rabin": "JA6Y"}],
    "c8RT": [function (require, module, exports) {
        module.exports = {
            modp1: {
                gen: "02",
    ...
    "DW0a": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var e = require("buffer").Buffer, t = require("bn.js"), r = require("miller-rabin"), i = new r, n = new t(24),
            o = new t(11), s = new t(10), u = new t(3), p = new t(7), h = require("./generatePrime"),
        ...
        function a(e, t) {
            var r = t.toString("hex"), f = [r, e.toString(16)].join("_");
        ...
        Object.defineProperty(g.prototype, "verifyError", {
            ...
            var i = (r = (r = new t(r)).toRed(this._prime)).redPow(this._priv).fromRed(), n = new e(i.toArray()),
                o = this.getPrime();
    ...
    }, {"bn.js": "a1T6", "miller-rabin": "JA6Y", "./generatePrime": "HqNM", "randombytes": "yWlW", "buffer": "MMtH"}],
    "LWeZ": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var e = require("buffer").Buffer, r = require("./lib/generatePrime"), i = require("./lib/primes.json"),
            n = require("./lib/dh");

        function f(r) {
            var f = new e(i[r].prime, "hex"), a = new e(i[r].gen, "hex");
            return new n(f, a)
        }
    ...
    }, {"./lib/generatePrime": "HqNM", "./lib/primes.json": "c8RT", "./lib/dh": "DW0a", "buffer": "MMtH"}],
    "CZ5R": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var e = require("buffer").Buffer, r = require("bn.js"), u = require("randombytes");
        ...
        function n(u, n) {
            var m = o(n), d = n.modulus.byteLength(), i = (r.mont(n.modulus), new r(u).mul(m.blinder).umod(n.modulus)),
                t = i.toRed(r.mont(n.prime1)), l = i.toRed(r.mont(n.prime2)), f = n.coefficient, p = n.prime1,
                s = n.prime2, b = t.redPow(n.exponent1), a = l.redPow(n.exponent2);
    ...
    }, {"bn.js": "a1T6", "randombytes": "yWlW", "buffer": "MMtH"}],
    "ynI1": [function (require, module, exports) {
        module.exports = {
            ...
            _resolved: "http://r.cnpmjs.org/elliptic/download/elliptic-6.5.2.tgz",
            _shasum: "05c5678d7173c049d8ca433552224a495d0e3762",
            _spec: "elliptic@^6.0.0",
            _where: "C:\\Users\\stern\\AppData\\Roaming\\npm\\node_modules\\parcel-bundler\\node_modules\\browserify-sign",
    ...
    "nB74": [function (require, module, exports) {
        "use strict";
        var r = exports;
        ...
        function e(r, e) {
            ...
            if ("hex" === e) {
                ...
                var o = r.charCodeAt(n), u = o >> 8, i = 255 & o;
    ...
    "ASTB": [function (require, module, exports) {
        "use strict";
        var r = exports, n = require("bn.js"), e = require("minimalistic-assert"),
        ...
        function o(r, n) {
            ...
            for (var t = 0, i = 0; r.cmpn(-t) > 0 || n.cmpn(-i) > 0;) {
                var o, s, a, u = r.andln(3) + t & 3, c = n.andln(3) + i & 3;
                if (3 === u && (u = -1), 3 === c && (c = -1), 0 == (1 & u)) o = 0; else o = 3 !== (a = r.andln(7) + t & 7) && 5 !== a || 2 !== c ? u : -u;
                if (e[0].push(o), 0 == (1 & c)) s = 0; else s = 3 !== (a = n.andln(7) + i & 7) && 5 !== a || 2 !== u ? c : -c;
    ...
    }, {"bn.js": "a1T6", "minimalistic-assert": "hGLJ", "minimalistic-crypto-utils": "nB74"}],
    "e3sZ": [function (require, module, exports) {
        "use strict";
        var t = require("bn.js"), e = require("../utils"), n = e.getNAF, r = e.getJSF, i = e.assert;
        ...
        module.exports = o, o.prototype.point = function () {
            ...
            i(t.precomputed);
            var r = t._getDoubles(), o = n(e, 1, this._bitLength), s = (1 << r.step + 1) - (r.step % 2 == 0 ? 2 : 1);
            s /= 3;
            ...
            for (a = o - 1; a >= 1; a -= 2) {
                ...
                if (1 === p[f] && 1 === p[c]) {
                    ...
                    var m = [-3, -1, -5, -7, 0, 7, 5, 1, 3], y = r(i[f], i[c]);
                    u = Math.max(y[0].length, u), d[f] = new Array(u), d[c] = new Array(u);
                    for (var v = 0; v < u; v++) {
                        var w = 0 | y[0][v], b = 0 | y[1][v];
            ...
            var _ = this.jpoint(null, null, null), A = this._wnafT4;
            for (a = u; a >= 0; a--) {
                for (var x = 0; a >= 0;) {
                    var N = !0;
    ...
    }, {"bn.js": "a1T6", "../utils": "ASTB"}],
    "f6c6": [function (require, module, exports) {
        "use strict";
        var r = require("../utils"), e = require("bn.js"), t = require("inherits"), d = require("./base"), i = r.assert;
        ...
        t(n, d), module.exports = n, n.prototype._getEndomorphism = function (r) {
            if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
                var t, d;
                if (r.beta) t = new e(r.beta, 16).toRed(this.red); else {
                    var n = this._getEndoRoots(this.p);
                    t = (t = n[0].cmp(n[1]) < 0 ? n[0] : n[1]).toRed(this.red)
                }
                if (r.lambda) d = new e(r.lambda, 16); else {
                ...
                return {
                    beta: t, lambda: d, basis: r.basis ? r.basis.map(function (r) {
                        return {a: new e(r.a, 16), b: new e(r.b, 16)}
                    }) : this._getEndoBasis(d)
                }
            }
        }, n.prototype._getEndoRoots = function (r) {
            var t = r === this.p ? this.red : e.mont(r), d = new e(2).toRed(t).redInvm(), i = d.redNeg(),
            ...
            for (var t, d, i, n, u, s, o, h, p, l = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), a = r, f = this.n.clone(), c = new e(1), S = new e(0), b = new e(0), v = new e(1), I = 0; 0 !== a.cmpn(0);) {
                ...
                var A = v.sub(y.mul(S));
                if (!i && h.cmp(l) < 0) t = o.neg(), d = c, i = h.neg(), n = p; else if (i && 2 == ++I) break;
            ...
            var e = this.endo.basis, t = e[0], d = e[1], i = d.b.mul(r).divRound(this.n),
                n = t.b.neg().mul(r).divRound(this.n), u = i.mul(t.a), s = n.mul(d.a), o = i.mul(t.b), h = n.mul(d.b);
            return {k1: r.sub(u).sub(s), k2: o.add(h).neg()}
        }, n.prototype.pointFromX = function (r, t) {
            (r = new e(r, 16)).red || (r = r.toRed(this.red));
            var d = r.redSqr().redMul(r).redIAdd(r.redMul(this.a)).redIAdd(this.b), i = d.redSqrt();
            ...
            for (var d = this._endoWnafT1, i = this._endoWnafT2, n = 0; n < r.length; n++) {
                var u = this._endoSplit(e[n]), s = r[n], o = s._getBeta();
            ...
            return d.precomputed = {
                beta: null,
                doubles: n.doubles && {step: n.doubles.step, points: [d].concat(n.doubles.points.map(i))},
            ...
            var e = this.curve.a, t = this.x.redSqr(), d = r.redInvm(), i = t.redAdd(t).redIAdd(t).redIAdd(e).redMul(d),
                n = i.redSqr().redISub(this.x.redAdd(this.x)), u = i.redMul(this.x.redSub(n)).redISub(this.y);
            ...
            if (r && this.precomputed) {
                var t = this.precomputed, d = function (r) {
                    return r.neg()
                };
                e.precomputed = {
            ...
            var e = r.z.redSqr(), t = this.z.redSqr(), d = this.x.redMul(e), i = r.x.redMul(t),
                n = this.y.redMul(e.redMul(r.z)), u = r.y.redMul(t.redMul(this.z)), s = d.redSub(i), o = n.redSub(u);
            if (0 === s.cmpn(0)) return 0 !== o.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
            var h = s.redSqr(), p = h.redMul(s), l = d.redMul(h), a = o.redSqr().redIAdd(p).redISub(l).redISub(l),
                f = o.redMul(l.redISub(a)).redISub(n.redMul(p)), c = this.z.redMul(r.z).redMul(s);
            return this.curve.jpoint(a, f, c)
        }, s.prototype.mixedAdd = function (r) {
            if (this.isInfinity()) return r.toJ();
            if (r.isInfinity()) return this;
            var e = this.z.redSqr(), t = this.x, d = r.x.redMul(e), i = this.y, n = r.y.redMul(e).redMul(this.z),
                u = t.redSub(d), s = i.redSub(n);
            if (0 === u.cmpn(0)) return 0 !== s.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
            var o = u.redSqr(), h = o.redMul(u), p = t.redMul(o), l = s.redSqr().redIAdd(h).redISub(p).redISub(p),
                a = s.redMul(p.redISub(l)).redISub(i.redMul(h)), f = this.z.redMul(u);
            ...
            var d = this.curve.a, i = this.curve.tinv, n = this.x, u = this.y, s = this.z, o = s.redSqr().redSqr(),
                h = u.redAdd(u);
            for (t = 0; t < r; t++) {
                var p = n.redSqr(), l = h.redSqr(), a = l.redSqr(), f = p.redAdd(p).redIAdd(p).redIAdd(d.redMul(o)),
                    c = n.redMul(l), S = f.redSqr().redISub(c.redAdd(c)), b = c.redISub(S), v = f.redMul(b);
            ...
            var r, e, t;
            if (this.zOne) {
                var d = this.x.redSqr(), i = this.y.redSqr(), n = i.redSqr(),
                    u = this.x.redAdd(i).redSqr().redISub(d).redISub(n);
                u = u.redIAdd(u);
                var s = d.redAdd(d).redIAdd(d), o = s.redSqr().redISub(u).redISub(u), h = n.redIAdd(n);
                h = (h = h.redIAdd(h)).redIAdd(h), r = o, e = s.redMul(u.redISub(o)).redISub(h), t = this.y.redAdd(this.y)
            } else {
                var p = this.x.redSqr(), l = this.y.redSqr(), a = l.redSqr(),
                    f = this.x.redAdd(l).redSqr().redISub(p).redISub(a);
                f = f.redIAdd(f);
                var c = p.redAdd(p).redIAdd(p), S = c.redSqr(), b = a.redIAdd(a);
            ...
            if (this.zOne) {
                var d = this.x.redSqr(), i = this.y.redSqr(), n = i.redSqr(),
                    u = this.x.redAdd(i).redSqr().redISub(d).redISub(n);
                u = u.redIAdd(u);
                var s = d.redAdd(d).redIAdd(d).redIAdd(this.curve.a), o = s.redSqr().redISub(u).redISub(u);
                r = o;
                var h = n.redIAdd(n);
                h = (h = h.redIAdd(h)).redIAdd(h), e = s.redMul(u.redISub(o)).redISub(h), t = this.y.redAdd(this.y)
            } else {
                var p = this.z.redSqr(), l = this.y.redSqr(), a = this.x.redMul(l),
                    f = this.x.redSub(p).redMul(this.x.redAdd(p));
                f = f.redAdd(f).redIAdd(f);
                var c = a.redIAdd(a), S = (c = c.redIAdd(c)).redAdd(c);
            ...
            var r = this.curve.a, e = this.x, t = this.y, d = this.z, i = d.redSqr().redSqr(), n = e.redSqr(),
                u = t.redSqr(), s = n.redAdd(n).redIAdd(n).redIAdd(r.redMul(i)), o = e.redAdd(e),
                h = (o = o.redIAdd(o)).redMul(u), p = s.redSqr().redISub(h.redAdd(h)), l = h.redISub(p), a = u.redSqr();
            a = (a = (a = a.redIAdd(a)).redIAdd(a)).redIAdd(a);
            var f = s.redMul(l).redISub(a), c = t.redAdd(t).redMul(d);
            return this.curve.jpoint(p, f, c)
        }, s.prototype.trpl = function () {
            if (!this.curve.zeroA) return this.dbl().add(this);
            var r = this.x.redSqr(), e = this.y.redSqr(), t = this.z.redSqr(), d = e.redSqr(),
                i = r.redAdd(r).redIAdd(r), n = i.redSqr(), u = this.x.redAdd(e).redSqr().redISub(r).redISub(d),
                s = (u = (u = (u = u.redIAdd(u)).redAdd(u).redIAdd(u)).redISub(n)).redSqr(), o = d.redIAdd(d);
    ...
    }, {"../utils": "ASTB", "bn.js": "a1T6", "inherits": "YJEE", "./base": "e3sZ"}],
    "Mlph": [function (require, module, exports) {
        "use strict";
        var t = require("bn.js"), r = require("inherits"), e = require("./base"), i = require("../utils");
        ...
        r(o, e), module.exports = o, o.prototype.validate = function (t) {
            var r = t.normalize().x, e = r.redSqr(), i = e.redMul(r).redAdd(e.redMul(this.a)).redAdd(r);
            ...
            var t = this.x.redAdd(this.z).redSqr(), r = this.x.redSub(this.z).redSqr(), e = t.redSub(r),
                i = t.redMul(r), o = e.redMul(r.redAdd(this.curve.a24.redMul(e)));
            return this.curve.point(i, o)
        }, n.prototype.add = function () {
            throw new Error("Not supported on Montgomery curve")
        }, n.prototype.diffAdd = function (t, r) {
            var e = this.x.redAdd(this.z), i = this.x.redSub(this.z), o = t.x.redAdd(t.z),
                n = t.x.redSub(t.z).redMul(e), d = o.redMul(i), u = r.z.redMul(n.redAdd(d).redSqr()),
    ...
    }, {"bn.js": "a1T6", "inherits": "YJEE", "./base": "e3sZ", "../utils": "ASTB"}],
    "fO5G": [function (require, module, exports) {
        "use strict";
        var t = require("../utils"), e = require("bn.js"), r = require("inherits"), i = require("./base"), d = t.assert;
        ...
        r(s, i), module.exports = s, s.prototype._mulA = function (t) {
            ...
            var i = t.redSqr(), d = this.c2.redSub(this.a.redMul(i)),
                s = this.one.redSub(this.c2.redMul(this.d).redMul(i)), u = d.redMul(s.redInvm()), h = u.redSqrt();
            ...
            (t = new e(t, 16)).red || (t = t.toRed(this.red));
            var i = t.redSqr(), d = i.redSub(this.c2), s = i.redMul(this.d).redMul(this.c2).redSub(this.a),
            ...
            t.normalize();
            var e = t.x.redSqr(), r = t.y.redSqr(), i = e.redMul(this.a).redAdd(r),
            ...
            r = r.redIAdd(r);
            var i = this.curve._mulA(t), d = this.x.redAdd(this.y).redSqr().redISub(t).redISub(e), s = i.redAdd(e),
                u = s.redSub(r), h = i.redSub(e), n = d.redMul(u), o = s.redMul(h), l = d.redMul(h), c = u.redMul(s);
            return this.curve.point(n, o, c, l)
        }, u.prototype._projDbl = function () {
            var t, e, r, i = this.x.redAdd(this.y).redSqr(), d = this.x.redSqr(), s = this.y.redSqr();
            if (this.curve.twisted) {
                var u = (o = this.curve._mulA(d)).redAdd(s);
                if (this.zOne) t = i.redSub(d).redSub(s).redMul(u.redSub(this.curve.two)), e = u.redMul(o.redSub(s)), r = u.redSqr().redSub(u).redSub(u); else {
                    var h = this.z.redSqr(), n = u.redSub(h).redISub(h);
            ...
            var e = this.y.redSub(this.x).redMul(t.y.redSub(t.x)), r = this.y.redAdd(this.x).redMul(t.y.redAdd(t.x)),
                i = this.t.redMul(this.curve.dd).redMul(t.t), d = this.z.redMul(t.z.redAdd(t.z)), s = r.redSub(e),
                u = d.redSub(i), h = d.redAdd(i), n = r.redAdd(e), o = s.redMul(u), l = h.redMul(n), c = s.redMul(n),
                p = u.redMul(h);
            return this.curve.point(o, l, p, c)
        }, u.prototype._projAdd = function (t) {
            var e, r, i = this.z.redMul(t.z), d = i.redSqr(), s = this.x.redMul(t.x), u = this.y.redMul(t.y),
                h = this.curve.d.redMul(s).redMul(u), n = d.redSub(h), o = d.redAdd(h),
                l = this.x.redAdd(this.y).redMul(t.x.redAdd(t.y)).redISub(s).redISub(u), c = i.redMul(n).redMul(l);
    ...
    "key7": [function (require, module, exports) {
        "use strict";
        var r = exports;
        r.base = require("./base"), r.short = require("./short"), r.mont = require("./mont"), r.edwards = require("./edwards");
    }, {"./base": "e3sZ", "./short": "f6c6", "./mont": "Mlph", "./edwards": "fO5G"}],
    "b5eD": [function (require, module, exports) {
        "use strict";
        var r = require("minimalistic-assert"), t = require("inherits");
        ...
        function e(r, t) {
            ...
            } else for (var o = 0, u = 0; u < r.length; u++) {
        ...
        function v(r, t, n, e) {
            var o = r[t], u = e + r[t + 1] >>> 0, i = (u < e ? 1 : 0) + n + o;
            r[t] = i >>> 0, r[t + 1] = u
        }
    ...
    "QABL": [function (require, module, exports) {
        "use strict";
        var t = require("./utils"), i = require("minimalistic-assert");
        ...
        exports.BlockHash = n, n.prototype.update = function (i, n) {
            ...
            var t = this.pendingTotal, i = this._delta8, n = i - (t + this.padLength) % i,
    ...
    }, {"./utils": "b5eD", "minimalistic-assert": "hGLJ"}],
    "PIZB": [function (require, module, exports) {
        "use strict";
        var r = require("../utils"), t = r.rotr32;
    ...
    "oTe4": [function (require, module, exports) {
        "use strict";
        var t = require("../utils"), h = require("../common"), i = require("./common"), s = t.rotl32, e = t.sum32,
            r = t.sum32_5, o = i.ft_1, n = h.BlockHash, u = [1518500249, 1859775393, 2400959708, 3395469782];
        ...
        t.inherits(a, n), module.exports = a, a.blockSize = 512, a.outSize = 160, a.hmacStrength = 80, a.padLength = 64, a.prototype._update = function (t, h) {
            ...
            var a = this.h[0], c = this.h[1], l = this.h[2], f = this.h[3], m = this.h[4];
            for (n = 0; n < i.length; n++) {
                var p = ~~(n / 20), g = r(s(a, 5), o(p, c, l, f), m, i[n], u[p]);
    ...
    }, {"../utils": "b5eD", "../common": "QABL", "./common": "PIZB"}],
    "owiA": [function (require, module, exports) {
        "use strict";
        var h = require("../utils"), t = require("../common"), i = require("./common"),
            s = require("minimalistic-assert"), e = h.sum32, r = h.sum32_4, n = h.sum32_5, o = i.ch32, u = i.maj32,
            a = i.s0_256, c = i.s1_256, l = i.g0_256, m = i.g1_256, g = t.BlockHash,
        ...
        h.inherits(p, g), module.exports = p, p.blockSize = 512, p.outSize = 256, p.hmacStrength = 192, p.padLength = 64, p.prototype._update = function (h, t) {
            ...
            var f = this.h[0], p = this.h[1], _ = this.h[2], k = this.h[3], d = this.h[4], q = this.h[5], v = this.h[6],
                b = this.h[7];
            for (s(this.k.length === i.length), g = 0; g < i.length; g++) {
                var x = n(b, c(d), o(d, q, v), this.k[g], i[g]), y = e(a(f), u(f, p, _));
    ...
    }, {"../utils": "b5eD", "../common": "QABL", "./common": "PIZB", "minimalistic-assert": "hGLJ"}],
    "Oewx": [function (require, module, exports) {
        "use strict";
        var t = require("../utils"), i = require("./256");
    ...
    "wBqE": [function (require, module, exports) {
        "use strict";
        var t = require("../utils"), h = require("../common"), i = require("minimalistic-assert"), r = t.rotr64_hi,
            n = t.rotr64_lo, s = t.shr64_hi, e = t.shr64_lo, u = t.sum64, o = t.sum64_hi, a = t.sum64_lo,
            c = t.sum64_4_hi, f = t.sum64_4_lo, l = t.sum64_5_hi, v = t.sum64_5_lo, _ = h.BlockHash,
        ...
        t.inherits(m, _), module.exports = m, m.blockSize = 1024, m.outSize = 512, m.hmacStrength = 192, m.padLength = 128, m.prototype._prepareBlock = function (t, h) {
            ...
            for (; r < i.length; r += 2) {
                var n = w(i[r - 4], i[r - 3]), s = z(i[r - 4], i[r - 3]), e = i[r - 14], u = i[r - 13],
                    o = S(i[r - 30], i[r - 29]), a = W(i[r - 30], i[r - 29]), l = i[r - 32], v = i[r - 31];
                i[r] = c(n, s, e, u, o, a, l, v), i[r + 1] = f(n, s, e, u, o, a, l, v)
            }
        }, m.prototype._update = function (t, h) {
            this._prepareBlock(t, h);
            var r = this.W, n = this.h[0], s = this.h[1], e = this.h[2], c = this.h[3], f = this.h[4], _ = this.h[5],
                p = this.h[6], m = this.h[7], S = this.h[8], W = this.h[9], w = this.h[10], z = this.h[11],
                H = this.h[12], A = this.h[13], L = this.h[14], j = this.h[15];
            i(this.k.length === r.length);
            for (var C = 0; C < r.length; C += 2) {
                var D = L, E = j, F = x(S, W), G = B(S, W), I = g(S, W, w, z, H, A), J = k(S, W, w, z, H, A),
                    K = this.k[C], M = this.k[C + 1], N = r[C], O = r[C + 1], P = l(D, E, F, G, I, J, K, M, N, O),
                    Q = v(D, E, F, G, I, J, K, M, N, O);
                D = b(n, s), E = q(n, s), F = d(n, s, e, c, f, _), G = y(n, s, e, c, f, _);
                var R = o(D, E, F, G), T = a(D, E, F, G);
    ...
    }, {"../utils": "b5eD", "../common": "QABL", "minimalistic-assert": "hGLJ"}],
    "SGNa": [function (require, module, exports) {
        "use strict";
        var t = require("../utils"), i = require("./512");
    ...
    "yJuD": [function (require, module, exports) {
        "use strict";
    ...
    }, {"./sha/1": "oTe4", "./sha/224": "Oewx", "./sha/256": "owiA", "./sha/384": "SGNa", "./sha/512": "wBqE"}],
    "B6Dw": [function (require, module, exports) {
        "use strict";
        var t = require("./utils"), h = require("./common"), i = t.rotl32, s = t.sum32, e = t.sum32_3, r = t.sum32_4,
            n = h.BlockHash;
    ...
    }, {"./utils": "b5eD", "./common": "QABL"}],
    "hD9S": [function (require, module, exports) {
        "use strict";
        var t = require("./utils"), i = require("minimalistic-assert");
    ...
    "lM6X": [function (require, module, exports) {
        module.exports = {
            doubles: {
                step: 4,
    ...
    "tXGw": [function (require, module, exports) {
        "use strict";
        var f, e = exports, a = require("hash.js"), b = require("./curve"), c = require("./utils"), d = c.assert;
    ...
    }, {"hash.js": "TKcf", "./curve": "key7", "./utils": "ASTB", "./precomputed/secp256k1": "lM6X"}],
    "T2PK": [function (require, module, exports) {
        "use strict";
        var t = require("hash.js"), e = require("minimalistic-crypto-utils"), i = require("minimalistic-assert");

        function s(t) {
            if (!(this instanceof s)) return new s(t);
            this.hash = t.hash, this.predResist = !!t.predResist, this.outLen = this.hash.outSize, this.minEntropy = t.minEntropy || this.hash.hmacStrength, this._reseed = null, this.reseedInterval = null, this.K = null, this.V = null;
            var h = e.toArray(t.entropy, t.entropyEnc || "hex"), r = e.toArray(t.nonce, t.nonceEnc || "hex"),
    ...
    }, {"hash.js": "TKcf", "minimalistic-crypto-utils": "nB74", "minimalistic-assert": "hGLJ"}],
    "pkTI": [function (require, module, exports) {
        "use strict";
        var t = require("bn.js"), i = require("../utils"), e = i.assert;
    ...
    "Q2Pd": [function (require, module, exports) {
        "use strict";
        var r = require("bn.js"), e = require("../utils"), t = e.assert;

        function a(e, n) {
            if (e instanceof a) return e;
            this._importDER(e, n) || (t(e.r && e.s, "Signature without r or s"), this.r = new r(e.r, 16), this.s = new r(e.s, 16), void 0 === e.recoveryParam ? this.recoveryParam = null : this.recoveryParam = e.recoveryParam)
        }
        ...
        module.exports = a, a.prototype._importDER = function (t, a) {
            t = e.toArray(t, a);
            var i = new n;
            if (48 !== t[i.place++]) return !1;
            if (c(t, i) + i.place !== t.length) return !1;
            if (2 !== t[i.place++]) return !1;
            var o = c(t, i), s = t.slice(i.place, o + i.place);
            if (i.place += o, 2 !== t[i.place++]) return !1;
            var l = c(t, i);
            if (t.length !== l + i.place) return !1;
            var u = t.slice(i.place, l + i.place);
            return 0 === s[0] && 128 & s[1] && (s = s.slice(1)), 0 === u[0] && 128 & u[1] && (u = u.slice(1)), this.r = new r(s), this.s = new r(u), this.recoveryParam = null, !0
        }, a.prototype.toDER = function (r) {
            var t = this.r.toArray(), a = this.s.toArray();
            for (128 & t[0] && (t = [0].concat(t)), 128 & a[0] && (a = [0].concat(a)), t = i(t), a = i(a); !(a[0] || 128 & a[1]);) a = a.slice(1);
            var n = [2];
            o(n, t.length), (n = n.concat(t)).push(2), o(n, a.length);
            var c = n.concat(a), s = [48];
            return o(s, c.length), s = s.concat(c), e.encode(s, r)
        };
    }, {"bn.js": "a1T6", "../utils": "ASTB"}],
    "QUFy": [function (require, module, exports) {
        "use strict";
        var r = require("bn.js"), e = require("hmac-drbg"), t = require("../utils"), n = require("../curves"),
            i = require("brorand"), s = t.assert, o = require("./key"), u = require("./signature");

        function h(r) {
            if (!(this instanceof h)) return new h(r);
            "string" == typeof r && (s(n.hasOwnProperty(r), "Unknown curve " + r), r = n[r]), r instanceof n.PresetCurve && (r = {curve: r}), this.curve = r.curve.curve, this.n = this.curve.n, this.nh = this.n.ushrn(1), this.g = this.curve.g, this.g = r.curve.g, this.g.precompute(r.curve.n.bitLength() + 1), this.hash = r.hash || r.curve.hash
        }
        ...
        module.exports = h, h.prototype.keyPair = function (r) {
            ...
            var h, c = o.invm(this.n), a = c.mul(e).umod(this.n), p = c.mul(s).umod(this.n);
            ...
            var o = this.n, h = new r(e), c = t.r, a = t.s, p = 1 & n, m = n >> 1;
            ...
            var v = t.r.invm(o), y = o.sub(h).mul(v).umod(o), f = a.mul(v).umod(o);
    ...
    "FJIx": [function (require, module, exports) {
        "use strict";
        var t = require("../utils"), e = t.assert, s = t.parseBytes, i = t.cachedProperty;
        ...
        n.fromPublic = function (t, e) {
            ...
            var t = this.eddsa, e = this.hash(), s = t.encodingLength - 1, i = e.slice(0, t.encodingLength);
    ...
    "fvgT": [function (require, module, exports) {
        "use strict";
        var e = require("bn.js"), t = require("../utils"), n = t.assert, o = t.cachedProperty, d = t.parseBytes;
    ...
    "HXzX": [function (require, module, exports) {
        "use strict";
        var t = require("hash.js"), e = require("../curves"), n = require("../utils"), r = n.assert, i = n.parseBytes,
            o = require("./key"), s = require("./signature");
        ...
        module.exports = u, u.prototype.sign = function (t, e) {
            t = i(t);
            var n = this.keyFromSecret(e), r = this.hashInt(n.messagePrefix(), t), o = this.g.mul(r),
                s = this.encodePoint(o), u = this.hashInt(s, n.pubBytes(), t).mul(n.priv()),
            ...
            var r = this.keyFromPublic(n), o = this.hashInt(e.Rencoded(), r.pubBytes(), t), s = this.g.mul(e.S());
            ...
            var e = (t = n.parseBytes(t)).length - 1, r = t.slice(0, e).concat(-129 & t[e]), i = 0 != (128 & t[e]),
                o = n.intFromLE(r);
    ...
    }, {"hash.js": "TKcf", "../curves": "tXGw", "../utils": "ASTB", "./key": "FJIx", "./signature": "fvgT"}],
    "gwax": [function (require, module, exports) {
        "use strict";
        var e = exports;
        ...
        "brorand": "h8aG",
        "./elliptic/curve": "key7",
        "./elliptic/curves": "tXGw",
        "./elliptic/ec": "QUFy",
        "./elliptic/eddsa": "HXzX"
    }],
    "E56f": [function (require, module, exports) {
    ...
    "MAtD": [function (require, module, exports) {
        var e = require("../asn1"), t = require("inherits"), n = exports;
    ...
    }, {"../asn1": "LMZy", "inherits": "YJEE", "vm": "E56f"}],
    "eEyz": [function (require, module, exports) {
        ...
        exports.Reporter = r, r.prototype.isError = function (t) {
            ...
            var r = this._reporterState, e = r.obj;
            return r.obj = t, e
        }, r.prototype.error = function (t) {
            var r, o = this._reporterState, p = t instanceof e;
    ...
    "XZCE": [function (require, module, exports) {
        ...
        var t = require("inherits"), e = require("../base").Reporter, r = require("buffer").Buffer;
        ...
        function i(t, e) {
            ...
            } else if ("string" == typeof t) this.value = t, this.length = r.byteLength(t); else {
    ...
    }, {"inherits": "YJEE", "../base": "aZ4m", "buffer": "MMtH"}],
    "eJpd": [function (require, module, exports) {
        var e = require("../base").Reporter, t = require("../base").EncoderBuffer, r = require("../base").DecoderBuffer,
        ...
        c.prototype.clone = function () {
            ...
            return Object.keys(r.choice).some(function (o) {
                var s = e.save(), c = r.choice[o];
                try {
                    var a = c._decode(e, t);
                    if (e.isError(a)) return !1;
                    i = {type: o, value: a}, n = !0
                } catch (l) {
            ...
            var s = null, c = !1;
            if (n.any) o = this._createEncoderBuffer(t); else if (n.choice) o = this._encodeChoice(t, r); else if (n.contains) s = this._getUse(n.contains, i)._encode(t, r), c = !0; else if (n.children) s = n.children.map(function (e) {
    ...
    }, {"../base": "aZ4m", "minimalistic-assert": "hGLJ"}],
    "aZ4m": [function (require, module, exports) {
        var e = exports;
    ...
    }, {"./reporter": "eEyz", "./buffer": "XZCE", "./node": "eJpd"}],
    "WC9n": [function (require, module, exports) {
    ...
    "P1AA": [function (require, module, exports) {
        var r = exports;
    ...
    "NWid": [function (require, module, exports) {
        var r = require("inherits"), t = require("../../asn1"), e = t.base, i = t.bignum, o = t.constants.der;
        ...
        module.exports = n, n.prototype.decode = function (r, t) {
            ...
            var i = r.save(), o = a(r, 'Failed to peek tag: "' + t + '"');
            ...
            var n = r.save(), s = this._skipUntilEnd(r, 'Failed to skip indefinite length body: "' + this.tag + '"');
            ...
            if ("bitstr" === t) {
                var e = r.readUInt8();
                return r.isError(e) ? e : {unused: e, data: r.raw()}
            }
            if ("bmpstr" === t) {
                var i = r.raw();
            ...
            if ("gentime" === t) var i = 0 | e.slice(0, 4), o = 0 | e.slice(4, 6), n = 0 | e.slice(6, 8),
                s = 0 | e.slice(8, 10), a = 0 | e.slice(10, 12), u = 0 | e.slice(12, 14); else {
            ...
            var e = r.raw(), o = new i(e);
            return t && (o = t[o.toString(10)] || o), o
        }, s.prototype._use = function (r, t) {
            return "function" == typeof r && (r = r(t)), r._getDecoder("der").tree
        };
    }, {"inherits": "YJEE", "../../asn1": "LMZy"}],
    "KS9E": [function (require, module, exports) {

        var e = require("inherits"), r = require("buffer").Buffer, i = require("./der");
    ...
    }, {"inherits": "YJEE", "buffer": "MMtH", "./der": "NWid"}],
    "B8h6": [function (require, module, exports) {
        var e = exports;
        e.der = require("./der"), e.pem = require("./pem");
    }, {"./der": "NWid", "./pem": "KS9E"}],
    "pX01": [function (require, module, exports) {

        var e = require("inherits"), r = require("buffer").Buffer, t = require("../../asn1"), n = t.base,
            o = t.constants.der;
        ...
        function u(e, r, t, n) {
            var i;
            if ("seqof" === e ? e = "seq" : "setof" === e && (e = "set"), o.tagByName.hasOwnProperty(e)) i = o.tagByName[e]; else {
    ...
    }, {"inherits": "YJEE", "buffer": "MMtH", "../../asn1": "LMZy"}],
    "FCo5": [function (require, module, exports) {
        var e = require("inherits"), r = require("./der");
    ...
    }, {"inherits": "YJEE", "./der": "pX01"}],
    "mJ2j": [function (require, module, exports) {
        var e = exports;
        e.der = require("./der"), e.pem = require("./pem");
    }, {"./der": "pX01", "./pem": "FCo5"}],
    "LMZy": [function (require, module, exports) {
        var e = exports;
    ...
    "u8or": [function (require, module, exports) {
        "use strict";
        var e = require("asn1.js"), i = e.define("Time", function () {
    ...
    "U7Pa": [function (require, module, exports) {
        "use strict";
    ...
    }, {"asn1.js": "LMZy", "./certificate": "u8or"}],
    "GQDO": [function (require, module, exports) {
        module.exports = {
    ...
    "C1c3": [function (require, module, exports) {

        var e = /Proc-Type: 4,ENCRYPTED[\n\r]+DEK-Info: AES-((?:128)|(?:192)|(?:256))-CBC,([0-9A-H]+)[\n\r]+([0-9A-z\n\r\+\/\=]+)[\n\r]+/m,
            r = /^-----BEGIN ((?:.*? KEY)|CERTIFICATE)-----/m,
            a = /^-----BEGIN ((?:.*? KEY)|CERTIFICATE)-----([0-9A-z\n\r\+\/\=]+)-----END \1-----$/m,
            n = require("evp_bytestokey"), t = require("browserify-aes"), s = require("safe-buffer").Buffer;
        module.exports = function (E, c) {
            var f, i = E.toString(), o = i.match(e);
            if (o) {
                var u = "aes" + o[1], p = s.from(o[2], "hex"), m = s.from(o[3].replace(/[\r\n]/g, ""), "base64"),
                    I = n(c, p.slice(0, 8), parseInt(o[1], 10)).key, h = [], C = t.createDecipheriv(u, I, p);
                h.push(C.update(m)), h.push(C.final()), f = s.concat(h)
            } else {
                var l = i.match(a);
                f = new s(l[2].replace(/[\r\n]/g, ""), "base64")
            }
            return {tag: i.match(r)[1], data: f}
        };
    }, {"evp_bytestokey": "vGPV", "browserify-aes": "bDOc", "safe-buffer": "cZJc"}],
    "lnSp": [function (require, module, exports) {

        var e = require("./asn1"), r = require("./aesid.json"), a = require("./fixProc"), t = require("browserify-aes"),
            i = require("pbkdf2"), c = require("safe-buffer").Buffer;

        function d(r) {
            var t;
            "object" != typeof r || c.isBuffer(r) || (t = r.passphrase, r = r.key), "string" == typeof r && (r = c.from(r));
            var i, d, o = a(r, t), u = o.tag, n = o.data;
            switch (u) {
                case"CERTIFICATE":
                ...
                case"EC PRIVATE KEY":
                    return {curve: (n = e.ECPrivateKey.decode(n, "der")).parameters.value, privateKey: n.privateKey};
                default:
                    throw new Error("unknown key type " + u)
            }
        }
        ...
        function s(e, a) {
            var d = e.algorithm.decrypt.kde.kdeparams.salt,
                ...
                o = r[e.algorithm.decrypt.cipher.algo.join(".")], u = e.algorithm.decrypt.cipher.iv,
                n = e.subjectPrivateKey, y = parseInt(o.split("-")[1], 10) / 8, p = i.pbkdf2Sync(a, d, s, y, "sha1"),
                K = t.createDecipheriv(o, p, u), l = [];
    ...
    "x2WM": [function (require, module, exports) {
        module.exports = {
    ...
    "CvEo": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var e = require("buffer").Buffer, r = require("create-hmac"), t = require("browserify-rsa"),
            n = require("elliptic").ec, a = require("bn.js"), u = require("parse-asn1"), o = require("./curves.json");
        ...
        function s(t, n, a, u) {
            ...
            var i = a.length, d = v(a, n), p = new e(i);
            p.fill(1);
            var c = new e(i);
        ...
        function g(e, r) {
            var t = new a(e), n = (e.length << 3) - r.bitLength();
    ...
    "ZHi8": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var r = require("buffer").Buffer, e = require("bn.js"), n = require("elliptic").ec, t = require("parse-asn1"),
        ...
        function u(r, e, t) {
            ...
            var u = new n(a), i = t.data.subjectPrivateKey.data;
            return u.verify(e, r, i)
        }

        function i(r, n, o) {
            var a = o.data.p, u = o.data.q, i = o.data.g, c = o.data.pub_key, w = t.signature.decode(r, "der"), s = w.s,
                f = w.r;
            d(s, u), d(f, u);
            var l = e.mont(a), m = s.invm(u);
        ...
        module.exports = a;
    }, {"bn.js": "a1T6", "elliptic": "gwax", "parse-asn1": "lnSp", "./curves.json": "x2WM", "buffer": "MMtH"}],
    "vH2V": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var t = require("buffer").Buffer, e = require("create-hash"), i = require("stream"), r = require("inherits"),
            s = require("./sign"), n = require("./verify"), h = require("./algorithms.json");
        ...
        Object.keys(h).forEach(function (e) {
            ...
            this.end();
            var i = this._hash.digest(), r = s(i, t, this._hashType, this._signType, this._tag);
        ...
        }, module.exports = {Sign: u, Verify: p, createSign: u, createVerify: p};
    }, {
        "create-hash": "uodg",
        "stream": "Gy6E",
        "inherits": "YJEE",
        "./sign": "CvEo",
        "./verify": "ZHi8",
        "./algorithms.json": "hTYa",
        "buffer": "MMtH"
    }],
    "cmfY": [function (require, module, exports) {
        var Buffer = require("buffer").Buffer;
        var e = require("buffer").Buffer, t = require("elliptic"), r = require("bn.js");
        module.exports = function (e) {
            return new n(e)
        };
        var i = {
    ...
    }, {"elliptic": "gwax", "bn.js": "a1T6", "buffer": "MMtH"}],
    "xJ0l": [function (require, module, exports) {

        var e = require("create-hash"), r = require("safe-buffer").Buffer;
    ...
    }, {"create-hash": "uodg", "safe-buffer": "cZJc"}],
    "k111": [function (require, module, exports) {
        module.exports = function (r, e) {
            for (var n = r.length, o = -1; ++o < n;) r[o] ^= e[o];
            return r
        };
    }, {}],
    "Ehth": [function (require, module, exports) {

        var e = require("bn.js"), r = require("safe-buffer").Buffer;
        ...
        module.exports = o;
    }, {"bn.js": "a1T6", "safe-buffer": "cZJc"}],
    "NvrM": [function (require, module, exports) {

        var r = require("parse-asn1"), e = require("randombytes"), o = require("create-hash"), n = require("./mgf"),
            a = require("./xor"), t = require("bn.js"), u = require("./withPublic"), l = require("browserify-rsa"),
            i = require("safe-buffer").Buffer;

        function s(r, u) {
            var l = r.modulus.byteLength(), s = u.length, f = o("sha1").update(i.alloc(0)).digest(), c = f.length,
                g = 2 * c;
            if (s > l - g - 2) throw new Error("message too long");
            var d = i.alloc(l - s - g - 2), h = l - c - 1, w = e(c),
                m = a(i.concat([f, d, i.alloc(1, 1), u], h), n(w, h)), q = a(w, n(m, c));
            return new t(i.concat([i.alloc(1), q, m], l))
        }

        function f(r, e, o) {
            var n, a = e.length, u = r.modulus.byteLength();
        ...
        module.exports = function (e, o, n) {
            ...
            var i, c = r(e);
            if (4 === a) i = s(c, o); else if (1 === a) i = f(c, o, n); else {
    ...
    "r8kS": [function (require, module, exports) {

        var r = require("parse-asn1"), e = require("./mgf"), n = require("./xor"), t = require("bn.js"),
            o = require("browserify-rsa"), i = require("create-hash"), u = require("./withPublic"),
            a = require("safe-buffer").Buffer;

        function l(r, t) {
            var o = r.modulus.byteLength(), u = i("sha1").update(a.alloc(0)).digest(), l = u.length;
            if (0 !== t[0]) throw new Error("decryption error");
            var f = t.slice(1, l + 1), c = t.slice(l + 1), s = n(f, e(c, l)), g = n(c, e(s, o - l - 1));
        ...
        module.exports = function (e, n, i) {
            ...
            var c, s = r(e), g = s.modulus.byteLength();
    ...
    "DKLQ": [function (require, module, exports) {
    ...
    }, {"./publicEncrypt": "NvrM", "./privateDecrypt": "r8kS"}],
    "gI0P": [function (require, module, exports) {

        var global = arguments[3];
        var process = require("process");
        var r = arguments[3], e = require("process");

        function n() {
            throw new Error("secure random number generation not supported by this browser\nuse chrome, FireFox or Internet Explorer 11")
        }

        var t = require("safe-buffer"), o = require("randombytes"), f = t.Buffer, u = t.kMaxLength,
            i = r.crypto || r.msCrypto, a = Math.pow(2, 32) - 1;
        ...
        function l(e, n, t, o) {
            ...
            if ("function" == typeof n) o = n, n = 0, t = e.length; else if ("function" == typeof t) o = t, t = e.length - n; else if ("function" != typeof o) throw new TypeError('"cb" argument must be a function');
            return s(n, e.length), m(t, n, e.length), p(e, n, t, o)
        }

        function p(r, n, t, o) {
            var f = r.buffer, u = new Uint8Array(f, n, t);
    ...
    }, {"safe-buffer": "cZJc", "randombytes": "yWlW", "process": "JNDr"}],
    "Tfu7": [function (require, module, exports) {
        "use strict";
        ...
        var e = require("browserify-sign/algos"), r = Object.keys(e),
        ...
        "create-hash": "uodg",
        "create-hmac": "R8He",
        "browserify-sign/algos": "IYru",
        "pbkdf2": "mhox",
        "browserify-cipher": "XOFb",
        "diffie-hellman": "LWeZ",
        "browserify-sign": "vH2V",
        "create-ecdh": "cmfY",
        "public-encrypt": "DKLQ",
        "randomfill": "gI0P"
    }],
    "KOvs": [function (require, module, exports) {
        ...
        !function (n, e) {
            ...
            var t = t || function (t, e) {
                var i;
                if ("undefined" != typeof window && window.crypto && (i = window.crypto), !i && "undefined" != typeof window && window.msCrypto && (i = window.msCrypto), !i && void 0 !== n && n.crypto && (i = n.crypto), !i && "function" == typeof require) try {
                    i = require("crypto")
                } catch (w) {
                }
                var r = function () {
                    ...
                    reset: function () {
                        ...
                        var e, i = this._data, r = i.words, o = i.sigBytes, s = this.blockSize, a = o / (4 * s),
                            c = (a = n ? t.ceil(a) : t.max((0 | a) - this._minBufferSize, 0)) * s, f = t.min(4 * c, o);
                        if (c) {
            ...
            return function () {
                ...
                var s = r.SHA512 = o.extend({
                    _doReset: function () {
                        ...
                        for (var o = this._hash.words, e = o[0], t = o[1], n = o[2], r = o[3], l = o[4], s = o[5], c = o[6], g = o[7], u = e.high, f = e.low, _ = t.high, d = t.low, p = n.high, v = n.low, H = r.high, y = r.low, x = l.high, S = l.low, A = s.high, m = s.low, B = c.high, b = c.low, k = g.high, q = g.low, z = u, W = f, j = _, C = d, D = p, F = v, J = H, M = y, P = x, R = S, X = A, E = m, G = B, I = b, K = k, L = q, N = 0; N < 80; N++) {
                            var O, Q, T = a[N];
                            if (N < 16) Q = T.high = 0 | i[h + 2 * N], O = T.low = 0 | i[h + 2 * N + 1]; else {
                                var U = a[N - 15], V = U.high, Y = U.low,
                                    Z = (V >>> 1 | Y << 31) ^ (V >>> 8 | Y << 24) ^ V >>> 7,
                                    $ = (Y >>> 1 | V << 31) ^ (Y >>> 8 | V << 24) ^ (Y >>> 7 | V << 25), ii = a[N - 2],
                                    hi = ii.high, oi = ii.low,
                                    ei = (hi >>> 19 | oi << 13) ^ (hi << 3 | oi >>> 29) ^ hi >>> 6,
                                    ti = (oi >>> 19 | hi << 13) ^ (oi << 3 | hi >>> 29) ^ (oi >>> 6 | hi << 26),
                                    ni = a[N - 7], ri = ni.high, li = ni.low, wi = a[N - 16], ai = wi.high, si = wi.low;
                                Q = (Q = (Q = Z + ri + ((O = $ + li) >>> 0 < $ >>> 0 ? 1 : 0)) + ei + ((O += ti) >>> 0 < ti >>> 0 ? 1 : 0)) + ai + ((O += si) >>> 0 < si >>> 0 ? 1 : 0), T.high = Q, T.low = O
                            }
                            var ci, gi = P & X ^ ~P & G, ui = R & E ^ ~R & I, fi = z & j ^ z & D ^ j & D,
                                _i = W & C ^ W & F ^ C & F,
                                di = (z >>> 28 | W << 4) ^ (z << 30 | W >>> 2) ^ (z << 25 | W >>> 7),
                                pi = (W >>> 28 | z << 4) ^ (W << 30 | z >>> 2) ^ (W << 25 | z >>> 7),
                                vi = (P >>> 14 | R << 18) ^ (P >>> 18 | R << 14) ^ (P << 23 | R >>> 9),
                                Hi = (R >>> 14 | P << 18) ^ (R >>> 18 | P << 14) ^ (R << 23 | P >>> 9), yi = w[N],
                                xi = yi.high, Si = yi.low, Ai = K + vi + ((ci = L + Hi) >>> 0 < L >>> 0 ? 1 : 0),
                                mi = pi + _i;
                            K = G, L = I, G = X, I = E, X = P, E = R, P = J + (Ai = (Ai = (Ai = Ai + gi + ((ci = ci + ui) >>> 0 < ui >>> 0 ? 1 : 0)) + xi + ((ci = ci + Si) >>> 0 < Si >>> 0 ? 1 : 0)) + Q + ((ci = ci + O) >>> 0 < O >>> 0 ? 1 : 0)) + ((R = M + ci | 0) >>> 0 < M >>> 0 ? 1 : 0) | 0, J = D, M = F, D = j, F = C, j = z, C = W, z = Ai + (di + fi + (mi >>> 0 < pi >>> 0 ? 1 : 0)) + ((W = ci + mi | 0) >>> 0 < ci >>> 0 ? 1 : 0) | 0
                        }
                        f = e.low = f + W, e.high = u + z + (f >>> 0 < W >>> 0 ? 1 : 0), d = t.low = d + C, t.high = _ + j + (d >>> 0 < C >>> 0 ? 1 : 0), v = n.low = v + F, n.high = p + D + (v >>> 0 < F >>> 0 ? 1 : 0), y = r.low = y + M, r.high = H + J + (y >>> 0 < M >>> 0 ? 1 : 0), S = l.low = S + R, l.high = x + P + (S >>> 0 < R >>> 0 ? 1 : 0), m = s.low = m + E, s.high = A + X + (m >>> 0 < E >>> 0 ? 1 : 0), b = c.low = b + I, c.high = B + G + (b >>> 0 < I >>> 0 ? 1 : 0), q = g.low = q + L, g.high = k + K + (q >>> 0 < L >>> 0 ? 1 : 0)
                    }, _doFinalize: function () {
    ...
    "zroK": [function (require, module, exports) {
        ...
        !function (o, t, e) {
            ...
            return function (o) {
                var t = r, e = t.lib, i = e.WordArray, h = e.Hasher, a = t.x64.Word, n = t.algo, c = [], s = [], f = [];
                !function () {
                    for (var r = 1, o = 0, t = 0; t < 24; t++) {
                        c[r + 5 * o] = (t + 1) * (t + 2) / 2 % 64;
                        var e = (2 * r + 3 * o) % 5;
                        r = o % 5, o = e
                    }
                    for (r = 0; r < 5; r++) for (o = 0; o < 5; o++) s[r + 5 * o] = o + (2 * r + 3 * o) % 5 * 5;
                ...
                var g = n.SHA3 = h.extend({
                    cfg: h.cfg.extend({outputLength: 512}), _doReset: function () {
                        ...
                        for (var n = 0; n < 24; n++) {
                            ...
                            for (var S = 1; S < 25; S++) {
                                var y = (B = t[S]).high, b = B.low, A = c[S];
                                A < 32 ? (v = y << A | b >>> 32 - A, u = b << A | y >>> 32 - A) : (v = b << A - 32 | y >>> 64 - A, u = y << A - 32 | b >>> 64 - A);
                                var k = l[s[S]];
                                k.high = v, k.low = u
                            }
                            var m = l[0], z = t[0];
                        ...
                        for (var a = this._state, n = this.cfg.outputLength / 8, c = n / 8, s = [], f = 0; f < c; f++) {
                            var l = a[f], g = l.high, v = l.low;
                            g = 16711935 & (g << 8 | g >>> 24) | 4278255360 & (g << 24 | g >>> 8), v = 16711935 & (v << 8 | v >>> 24) | 4278255360 & (v << 24 | v >>> 8), s.push(v), s.push(g)
                        }
    ...
    "QDOL": [function (require, module, exports) {
        ...
        !function (t, r, i) {
            ...
            var t, r, i, o, n, a, c;
            return r = (t = e).lib, i = r.Base, o = r.WordArray, n = t.algo, a = n.MD5, c = n.EvpKDF = i.extend({
                cfg: i.extend({
                    keySize: 4,
                    hasher: a,
                    iterations: 1
                    ...
                    for (var r, i = this.cfg, n = i.hasher.create(), a = o.create(), c = a.words, s = i.keySize, u = i.iterations; c.length < s;) {
                        r && n.update(r), r = n.update(e).finalize(t), n.reset();
                        for (var f = 1; f < u; f++) r = n.finalize(r), n.reset();
                        a.concat(r)
                    }
        ...
        !function (t, r, i) {
            ...
            e.lib.Cipher || function (t) {
                var r = e, i = r.lib, n = i.Base, c = i.WordArray, o = i.BufferedBlockAlgorithm, s = r.enc,
                    a = (s.Utf8, s.Base64), p = r.algo.EvpKDF, f = i.Cipher = o.extend({
                    ...
                    }, l = (i.BlockCipher = f.extend({
                        cfg: f.cfg.extend({mode: u, padding: _}), reset: function () {
                            var e;
                            f.reset.call(this);
                        ...
                        stringify: function (e) {
                            ...
                            return (r ? c.create([1398893684, 1701076831]).concat(r).concat(t) : t).toString(a)
                        }, parse: function (e) {
                            var t, r = a.parse(e), i = r.words;
                            return 1398893684 == i[0] && 1701076831 == i[1] && (t = c.create(i.slice(2, 4)), i.splice(0, 4), r.sigBytes -= 16), l.create({
                                ciphertext: r,
                                salt: t
                            })
                        }
                        ...
                        execute: function (e, t, r, i) {
                            ...
                            return n.sigBytes = 4 * t, l.create({key: n, iv: o, salt: i})
                        }
    ...
    "xYui": [function (require, module, exports) {
        ...
        !function (r, o, c) {
            ...
            return e.mode.CFB = function () {
                ...
                function o(e, r, o, c) {
                    var i, t = this._iv;
                    t ? (i = t.slice(0), this._iv = void 0) : i = this._prevBlock, c.encryptBlock(i, 0);
                    for (var n = 0; n < o; n++) e[r + n] ^= i[n]
                }
        ...
        !function (r, o, t) {
            ...
            return e.pad.ZeroPadding = {
                pad: function (e, r) {
                    ...
                    var r = e.words, o = e.sigBytes - 1;
                    for (o = e.sigBytes - 1; o >= 0; o--) if (r[o >>> 2] >>> 24 - o % 4 * 8 & 255) {
                        e.sigBytes = o + 1;
                        break
                    }
                }
    ...
    "Xa8o": [function (require, module, exports) {
        ...
        !function (r, o, t) {
            ...
            return function () {
                var r = e, o = r.lib.BlockCipher, t = r.algo, i = [], c = [], n = [], s = [], u = [], h = [], d = [],
                    f = [], a = [], y = [];
                !function () {
                    ...
                    for (r = 0; r < 256; r++) {
                        ...
                        var v = e[o], _ = e[v], k = e[_], l = 257 * e[p] ^ 16843008 * p;
                        n[o] = l << 24 | l >>> 8, s[o] = l << 16 | l >>> 16, u[o] = l << 8 | l >>> 24, h[o] = l;
                        l = 16843009 * k ^ 65537 * _ ^ 257 * v ^ 16843008 * o;
                        d[p] = l << 24 | l >>> 8, f[p] = l << 16 | l >>> 16, a[p] = l << 8 | l >>> 24, y[p] = l, o ? (o = v ^ e[e[e[k ^ v]]], t ^= e[e[t]]) : o = t = 1
                    }
                }();
                var p = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], v = t.AES = o.extend({
                    _doReset: function () {
                        if (!this._nRounds || this._keyPriorReset !== this._key) {
                            for (var e = this._keyPriorReset = this._key, r = e.words, o = e.sigBytes / 4, t = 4 * ((this._nRounds = o + 6) + 1), c = this._keySchedule = [], n = 0; n < t; n++) n < o ? c[n] = r[n] : (h = c[n - 1], n % o ? o > 6 && n % o == 4 && (h = i[h >>> 24] << 24 | i[h >>> 16 & 255] << 16 | i[h >>> 8 & 255] << 8 | i[255 & h]) : (h = i[(h = h << 8 | h >>> 24) >>> 24] << 24 | i[h >>> 16 & 255] << 16 | i[h >>> 8 & 255] << 8 | i[255 & h], h ^= p[n / o | 0] << 24), c[n] = c[n - o] ^ h);
                            for (var s = this._invKeySchedule = [], u = 0; u < t; u++) {
                                n = t - u;
                                if (u % 4) var h = c[n]; else h = c[n - 4];
                                s[u] = u < 4 || n <= 4 ? h : d[i[h >>> 24]] ^ f[i[h >>> 16 & 255]] ^ a[i[h >>> 8 & 255]] ^ y[i[255 & h]]
                            }
                        }
                    }, encryptBlock: function (e, r) {
                        this._doCryptBlock(e, r, this._keySchedule, n, s, u, h, i)
                    }, decryptBlock: function (e, r) {
                        var o = e[r + 1];
                        e[r + 1] = e[r + 3], e[r + 3] = o, this._doCryptBlock(e, r, this._invKeySchedule, d, f, a, y, c);
                        o = e[r + 1];
                        e[r + 1] = e[r + 3], e[r + 3] = o
                    }, _doCryptBlock: function (e, r, o, t, i, c, n, s) {
                        for (var u = this._nRounds, h = e[r] ^ o[0], d = e[r + 1] ^ o[1], f = e[r + 2] ^ o[2], a = e[r + 3] ^ o[3], y = 4, p = 1; p < u; p++) {
                            var v = t[h >>> 24] ^ i[d >>> 16 & 255] ^ c[f >>> 8 & 255] ^ n[255 & a] ^ o[y++],
                                _ = t[d >>> 24] ^ i[f >>> 16 & 255] ^ c[a >>> 8 & 255] ^ n[255 & h] ^ o[y++],
                                k = t[f >>> 24] ^ i[a >>> 16 & 255] ^ c[h >>> 8 & 255] ^ n[255 & d] ^ o[y++],
                                l = t[a >>> 24] ^ i[h >>> 16 & 255] ^ c[d >>> 8 & 255] ^ n[255 & f] ^ o[y++];
                            h = v, d = _, f = k, a = l
                        }
                        v = (s[h >>> 24] << 24 | s[d >>> 16 & 255] << 16 | s[f >>> 8 & 255] << 8 | s[255 & a]) ^ o[y++], _ = (s[d >>> 24] << 24 | s[f >>> 16 & 255] << 16 | s[a >>> 8 & 255] << 8 | s[255 & h]) ^ o[y++], k = (s[f >>> 24] << 24 | s[a >>> 16 & 255] << 16 | s[h >>> 8 & 255] << 8 | s[255 & d]) ^ o[y++], l = (s[a >>> 24] << 24 | s[h >>> 16 & 255] << 16 | s[d >>> 8 & 255] << 8 | s[255 & f]) ^ o[y++];
    ...
    "Evye": [function (require, module, exports) {
        ...
        var e;
        !function (t, r, c) {
            "object" == typeof exports ? module.exports = exports = r(require("./core"), require("./enc-base64"), require("./md5"), require("./evpkdf"), require("./cipher-core")) : "function" == typeof e && e.amd ? e(["./core", "./enc-base64", "./md5", "./evpkdf", "./cipher-core"], r) : r(t.CryptoJS)
        }(this, function (e) {
            return function () {
                var t = e, r = t.lib, c = r.WordArray, i = r.BlockCipher, l = t.algo,
                    o = [57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27, 19, 11, 3, 60, 52, 44, 36, 63, 55, 47, 39, 31, 23, 15, 7, 62, 54, 46, 38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 28, 20, 12, 4],
                    s = [14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2, 41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48, 44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29, 32],
                    h = [1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, 21, 23, 25, 27, 28], n = [{
                        0: 8421888,
                        268435456: 32768,
                        536870912: 8421378,
                        805306368: 2,
                    ...
                    _ = l.DES = i.extend({
                        _doReset: function () {
                            ...
                            for (var i = this._subKeys = [], l = 0; l < 16; l++) {
                                ...
                                n[0] = n[0] << 1 | n[0] >>> 31;
                                for (r = 1; r < 7; r++) n[r] = n[r] >>> 4 * (r - 1) + 3;
                                n[7] = n[7] << 5 | n[7] >>> 27
                            }
                            var _ = this._invSubKeys = [];
                            for (r = 0; r < 16; r++) _[r] = i[15 - r]
                            ...
                            for (var c = 0; c < 16; c++) {
                                for (var i = r[c], l = this._lBlock, o = this._rBlock, s = 0, h = 0; h < 8; h++) s |= n[h][((o ^ i[h]) & k[h]) >>> 0];
                                this._lBlock = o, this._rBlock = l ^ s
                            }
                            var _ = this._lBlock;
                            this._lBlock = this._rBlock, this._rBlock = _, a.call(this, 1, 1431655765), B.call(this, 8, 16711935), B.call(this, 2, 858993459), a.call(this, 16, 65535), a.call(this, 4, 252645135), e[t] = this._lBlock, e[t + 1] = this._rBlock
                ...
                t.DES = i._createHelper(_);
                var p = l.TripleDES = i.extend({
                    _doReset: function () {
                        var e = this._key.words;
                        if (2 !== e.length && 4 !== e.length && e.length < 6) throw new Error("Invalid key length - 3DES requires the key length to be 64, 128, 192 or >192.");
                        var t = e.slice(0, 2), r = e.length < 4 ? e.slice(0, 2) : e.slice(2, 4),
                            i = e.length < 6 ? e.slice(0, 2) : e.slice(4, 6);
                        this._des1 = _.createEncryptor(c.create(t)), this._des2 = _.createEncryptor(c.create(r)), this._des3 = _.createEncryptor(c.create(i))
                    }, encryptBlock: function (e, t) {
    ...
    "yfyO": [function (require, module, exports) {
        "use strict";
        var e = i(require("comlink")), t = r(require("crypto-js"));
        ...
        function u(e) {
            return e >= 0 && e <= 128 << 20 ? 262144 : e > 128 << 20 && e <= 256 << 20 ? 524288 : e > 256 << 20 && e <= 512 << 20 ? 1048576 : 2097152
        }

        var f = function () {
            function e() {
                o(this, e), this.gcid = "", this.gcidSHA1 = ""
            }

            return c(e, [{
                key: "create", value: function () {
                    this.gcid = "", this.gcidSHA1 = t.default.algo.SHA1.create()
                }
            }, {
                key: "calculate", value: function (e) {
                    console.log("worker 开始计算分片文件数据", e);
                    for (var r = e.byteLength, n = u(r), i = r / n, o = 0; o < i; o++) {
                        var a = t.default.lib.WordArray.create(e.slice(n * o, n * (o + 1))), c = t.default.SHA1(a);
                        this.gcidSHA1.update(c)
                    }
                    if (n * i < r) {
                        var f = t.default.lib.WordArray.create(e.slice(n * i, r)), l = t.default.SHA1(f);
                        this.gcidSHA1.update(l)
                    }
                }
            }, {
                key: "finalize", value: function () {
                    this.gcid = this.gcidSHA1.finalize().toString().toUpperCase(), console.log("worker计算出来的gcid", this.gcid)
                }
            }]), e
        }();
        e.expose(f);
    }, {"comlink": "JZPE", "crypto-js": "BXaB"}]
}, {}, ["yfyO"], null)
//# sourceMappingURL=/gcidWorker.js.map