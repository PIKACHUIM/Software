...
module.exports = function (e) {
    ...
    0: function (e, t, n) {
        ...
        "use strict";
        var r = n(71), i = n(107), o = Object.prototype.toString;
        ...
        const i = n(36), o = n(19), a = n(13), s = n(1).default.getLogger("Thunder.base.tools-utilities"), l = n(2),
        ...
        "use strict";
        var r = n(10), i = n(71), o = n(108), a = n(61);
        ...
        }, l.Cancel = n(78), l.CancelToken = n(124), l.isCancel = n(77), l.all = function (e) {
 ...
 */
        ...
        "use strict";
        var r = n(61), i = n(10), o = n(119), a = n(120);
        ...
        !function (e) {
            ...
            function h(e, t, n = "normal 12px sans-serif", r = 1) {
                ...
                do {
                    ...
                    if (!c) break;
                    let u = i(0, c.length, c, l, s);
                    if (-1 === u) break;
                    a = `${c.substr(0, u - 2 * (r - 1))}...${l}`
                } while (0);
                return a
            }
        ...
        "use strict";
        var r = n(10), i = n(72), o = n(74), a = n(111), s = n(112), l = n(62),
        ...
        "use strict";
        var r = n(10), i = n(121), o = n(77), a = n(61), s = n(122), l = n(123);
        ...
        !function (e) {
            ...
            function p(e, t) {
                return r(this, void 0, void 0, function* () {
                    ...
                    if (void 0 !== e && void 0 !== t) {
                        ...
                        n = null !== i && i.isDirectory() ? yield h(r) : yield u(r)
                    }
                    return n
                })
            }
            ...
            function v(e) {
                return r(this, void 0, void 0, function* () {
                    let n = !1;
                    return s.information("mkdirsAW", e), void 0 !== e && ((yield t(e)) ? n = !0 : o.dirname(e) === e ? n = !1 : (yield v(o.dirname(e))) && (n = yield l(e))), n
                })
            }
            ...
            }, e.mkdirAW = l, e.rmdirAW = c, e.unlinkAW = u, e.readdirAW = d, e.lstatAW = f, e.rmdirsAW = h, e.mkdirsAW = v, e.renameAW = function (e, t) {
                return r(this, void 0, void 0, function* () {
                    if (void 0 !== e && void 0 !== t) {
                        const n = a(i.rename);
                        try {
                ...
                return r(this, void 0, void 0, function* () {
                    ...
                    if (a.isDirectory()) {
                        ...
                        for (let l = 0; l < s.length; l++) {
                            let c = o.join(n, s[l]), u = o.join(i, s[l]);
                            (r = yield t(c)) && (r = (a = yield f(c)).isDirectory() ? yield e(c, u) : yield m(c, u))
                        }
                    }
                    return r
                })
        ...
        function d({url: e, data: t, method: o = "get"}, c = "prod") {
            return r(this, arguments, void 0, function* () {
                l.information("fetchFromApiProxy", arguments);
                try {
                    const r = yield Promise.all([i.client.callServerFunction("GetUserID"), i.client.callServerFunction("GetSessionID"), i.client.callServerFunction("GetPeerID")]), [d, f, p] = r;
                    l.information(r);
                    let h = {
                        _h: Object.assign({
                            "Account-Id": d,
                    ...
                    "get" === o && t && (m = t, t = null);
                    for (let e in m) s.isObject(m[e]) || (v[e] = m[e]);
                    let g = [];
                    for (let e in v) g.push(u(e) + "%3D" + u(v[e]));
                    g.sort();
                    let y = u(e), b = o.toUpperCase() + "&" + y + "&", C = "";
        ...
        function f({url: e, data: t, method: n = "get"}, o = "prod") {
            return r(this, void 0, void 0, function* () {
                ...
                return 1 === a && (r = c[o = "test"]), l.information("当前fetchSlRes 是否测试服:", a, " 远程地址:", r), d({
                    url: `${r}${e}`,
                    data: t,
                    method: n
                }, o)
        ...
        t.fetchFromApiProxy = d, t.fetchSlRes = f, t.fetchPCRes = function ({url: e, data: t, method: n = "get"}, i = "prod") {
            return r(this, void 0, void 0, function* () {
            ...
            return r(this, void 0, void 0, function* () {
                ...
                t && t._h && delete t._h;
                const d = yield n(39);
                d.defaults.adapter = n(25), d.defaults.headers["Content-Type"] = "post" === o ? "application/json" : "application/x-www-form-urlencoded";
                try {
                    return d.request({
                        method: o,
                        url: `${r}${e}`,
        ...
        !function (e) {
            ...
            function h(e) {
                ...
                do {
                    if (void 0 === e || null === e) break;
                    c.information("parseDynamicUrlPath"), e.match(/[\/]?([^?]*)\?([^\s]*)/) && (t.pageFileName = RegExp.$1, t.args = RegExp.$2), c.information("parseDynamicUrlPath ret", t)
                } while (0);
                return t
            }
            ...
            e.isDownloadFileExtName = t, e.isIllegalFileName = n, e.isGoodFileExtName = i, e.isUsualFileExtName = function (e) {
                ...
                return t
            }, e.isGoodFileName = l, e.parseDynamicUrlArgs = p, e.parseDynamicUrlPath = h, e.parseFileNameFromDynamicUrlPath = v, e.getFileNameListFromUrlPath = m, e.getNameFromUrl = function (e) {
                ...
                return y(e) && (t = u.parseThunderPrivateUrl(e)), t
        ...
        !function (e) {
            ...
            function i(e, t = "", i = "", o = 0, s = 0, c = 0, u = 0, d = "", f = 0) {
                return r(this, void 0, void 0, function* () {
                    let r = 0;
                    do {
                        if (void 0 === e) {
                        ...
                        r = "browser" === process.type ? yield new Promise(a => {
                            r = n().asyncTrackEvent(e, t, i, o, s, c, u, p, f, e => {
                                a(e)
                            })
                        }) : n().trackEvent(e, t, i, o, s, c, u, p, f), a.information(e, t, i, o, s, c, u, p, f)
                    } while (0);
                    return r
                })
            }
        ...
        Object.defineProperty(t, "__esModule", {value: !0}), function (e) {
            let t, n, r, i, o, a, s, l, c, u, d, f, p, h, v, m, g, y, b, C;
            !function (e) {
            ...
            }(C = e.XLResourceFrom || (e.XLResourceFrom = {}))
        ...
        "use strict";
        var r = n(10), i = n(72), o = n(74), a = n(54), s = n(63), l = n(75).http, c = n(75).https, u = n(34),
            d = n(64), f = n(118), p = n(62), h = n(73);
        e.exports = function (e) {
            return new Promise(function (t, n) {
                var v, m = e.data, g = e.headers;
                if (g["User-Agent"] || g["user-agent"] || (g["User-Agent"] = "axios/" + f.version), m && !r.isStream(m)) {
                    if (Buffer.isBuffer(m)) ; else if (r.isArrayBuffer(m)) m = new Buffer(new Uint8Array(m)); else {
                        if (!r.isString(m)) return n(p("Data after transformation must be a string, an ArrayBuffer, a Buffer, or a Stream", e));
                ...
                var b = u.parse(e.url), C = b.protocol || "http:";
                if (!y && b.auth) {
                    var w = b.auth.split(":");
                    y = (w[0] || "") + ":" + (w[1] || "")
                }
                ...
                var R, P = e.proxy;
                if (!P && !1 !== P) {
                    var k = C.slice(0, -1) + "_proxy", O = process.env[k] || process.env[k.toUpperCase()];
                    if (O) {
                        var E = u.parse(O);
                        if (P = {host: E.hostname, port: E.port}, E.auth) {
                            var D = E.auth.split(":");
                            P.auth = {username: D[0], password: D[1]}
                        }
                    }
                }
                ...
                var M = R.request(T, function (r) {
                    if (!M.aborted) {
                        ...
                        switch (r.headers["content-encoding"]) {
                            ...
                            case"compress":
                            case"deflate":
                                o = o.pipe(d.createUnzip()), delete r.headers["content-encoding"]
                        }
                        var a = r.req || M, s = {
                            status: r.statusCode,
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const o = n(5), a = n(3), s = n(7), l = n(677), c = n(684), u = n(38), d = n(4),
        ...
        let p = class extends o.Vue {
            ...
            mounted() {
                return i(this, void 0, void 0, function* () {
                    ...
                    this.logined = Number(n), f.information("mounted", "url", e, "logined", this.logined), this.logined = Number(yield d.client.callServerFunction("IsLogined")), this.onLoginSucCookie = u.NativeCallModule.nativeCall.AttachNativeEvent("onLoginSuc", () => i(this, void 0, void 0, function* () {
                        f.information("收到 onLoginSuc 事件"), this.logined = 1
                    })), this.onLogoutCookie = u.NativeCallModule.nativeCall.AttachNativeEvent("onLogout", () => {
            ...
            destroyed() {
                return i(this, void 0, void 0, function* () {
                    a.ipcRenderer.removeListener("personal-info-init-reply", this.handleInitReply), u.NativeCallModule.nativeCall.DetachNativeEvent("onLoginSuc", this.onLoginSucCookie), u.NativeCallModule.nativeCall.DetachNativeEvent("onLogout", this.onLogoutCookie)
                })
            }
        };
        p = r([o.Component({
        ...
        const o = n(5);
        n(942);
        const a = n(7), s = n(38), l = n(678), c = n(679), u = n(11), d = n(604),
            f = n(1).default.getLogger("personalInfo:login");
        let {isDef: p} = u.ThunderUtil;
        const h = n(197), v = n(681), m = c.VipGrowNS.getMaxVipLevel(), g = n(66), y = n(682), b = n(137), C = n(6),
            w = n(4), x = n(138), S = n(683);
        o.Vue.use(v.default);
        let T = class extends o.Vue {
            ...
            get strVipGrowUpgrade() {
                let e = "去了解>";
                return 3 === this.vipGrowUpgradeType && (e = this.vipLevel >= m ? "去了解" : "去提升"), e
            }
            ...
            get strVipBtnText() {
                let e = "开通下载会员";
                return p(this.vipConfig) && p(this.vipConfig.btn) && p(this.vipConfig.btn.btn_title) && "" !== this.vipConfig.btn.btn_title && (e = this.vipConfig.btn.btn_title), e
            }

            get strVipBtnTips() {
                let e = "";
                return this.vipLabConfig && this.vipLabConfig.xlx_ggong_pay_hover && this.vipLabConfig.xlx_ggong_pay_hover[0] && this.vipLabConfig.xlx_ggong_pay_hover[0].text && this.vipLabConfig.xlx_ggong_pay_hover[1] && this.vipLabConfig.xlx_ggong_pay_hover[1].text && (e = this.vipLabConfig.xlx_ggong_pay_hover[1].text), e
            }

            get strVipBtnLink() {
                let e = "";
                return this.vipLabConfig && this.vipLabConfig.xlx_ggong_pay_hover && this.vipLabConfig.xlx_ggong_pay_hover[0] && this.vipLabConfig.xlx_ggong_pay_hover[0].url && (e = S.VipLableConfigNS.getConfigUrl(this.vipLabConfig.xlx_ggong_pay_hover[0].referfrom, this.vipLabConfig.xlx_ggong_pay_hover[0].aidfrom, this.vipLabConfig.xlx_ggong_pay_hover[0].url)), e
            }

            get isVipLinkDef() {
                return !!(this.vipLabConfig && this.vipLabConfig.xlx_ggong_hover_wzl && this.vipLabConfig.xlx_ggong_hover_wzl[0] && this.vipLabConfig.xlx_ggong_hover_wzl[0].text && this.vipLabConfig.xlx_ggong_hover_wzl[0].url)
            }

            get strVipLinkText() {
                let e = "";
                return this.isVipLinkDef && (e = this.vipLabConfig.xlx_ggong_hover_wzl[0].text), e
            }

            get strVipWzlLink() {
                let e = "";
                return this.isVipLinkDef && (e = S.VipLableConfigNS.getConfigUrl(this.vipLabConfig.xlx_ggong_hover_wzl[0].referfrom, this.vipLabConfig.xlx_ggong_hover_wzl[0].aidfrom, this.vipLabConfig.xlx_ggong_hover_wzl[0].url)), e
            }
            ...
            getPayType() {
                if (this.vipLabConfig && this.vipLabConfig.xlx_ggong_pay_hover && this.vipLabConfig.xlx_ggong_pay_hover[0] && this.vipLabConfig.xlx_ggong_pay_hover[0].aidfrom) return this.vipLabConfig.xlx_ggong_pay_hover[0].aidfrom
            }

            getPayReferfrom() {
                if (this.vipLabConfig && this.vipLabConfig.xlx_ggong_pay_hover && this.vipLabConfig.xlx_ggong_pay_hover[0] && this.vipLabConfig.xlx_ggong_pay_hover[0].referfrom) return this.vipLabConfig.xlx_ggong_pay_hover[0].referfrom
            }

            getWzlType() {
                let e = void 0;
                return this.vipLabConfig && this.vipLabConfig.xlx_ggong_hover_wzl && this.vipLabConfig.xlx_ggong_hover_wzl[0] && this.vipLabConfig.xlx_ggong_hover_wzl[0].aidfrom && (e = this.vipLabConfig.xlx_ggong_hover_wzl[0].aidfrom), e
            }

            getWzlReferfrom() {
                let e = "v_pc_xlx_ggong_hover_wzl";
                return this.vipLabConfig && this.vipLabConfig.xlx_ggong_hover_wzl && this.vipLabConfig.xlx_ggong_hover_wzl[0] && this.vipLabConfig.xlx_ggong_hover_wzl[0].referfrom && (e = this.vipLabConfig.xlx_ggong_hover_wzl[0].referfrom), e
            }
                ...
                return i(this, void 0, void 0, function* () {
                    s.NativeCallModule.nativeCall.CallNativeFunction("GetAllUserInfo", (e, t) => {
                        ...
                        do {
                            ...
                            if (this.userID = t.userID, this.userNick = u.ThunderUtil.unescapeHTML(t.nickName), this.getCurUserHeader(), this.curScore = t.account, this.calculateScoreInfo(), null === t.vipList || void 0 === t.vipList) break;
            ...
            mounted() {
                return i(this, void 0, void 0, function* () {
                    ...
                    }), d.default.getLoginConfig().then(e => {
            ...
            initDefaultLabConfig() {
                if (!this.vipLabConfig || !this.vipLabConfig.xlx_ggong_pay_hover) {
                    let e = this.isVip && 5 === this.vipType;
                    this.vipLabConfig || (this.vipLabConfig = {xlx_ggong_pay_hover: []}), this.isContinueMonthPayVip ? this.vipLabConfig.xlx_ggong_pay_hover = [{
                        text: "领取连续包奖励金",
            ...
            initLabConfig() {
                return i(this, void 0, void 0, function* () {
                    let e = yield S.VipLableConfigNS.getConfig("xlx_ggong_hover_wzl,xlx_ggong_pay_hover");
                    e && e.xlx_ggong_pay_hover ? this.vipLabConfig = e : (this.isVip && this.vipType > 2 && (this.isContinueMonthPayVip = yield l.VipUserInfoNS.isContinueMonthPayVip(!0), this.isContinueMonthPayVip && this.vipLabConfig && this.vipLabConfig.xlx_ggong_pay_hover && (this.vipLabConfig.xlx_ggong_pay_hover = null)), e && (this.vipLabConfig = e), this.initDefaultLabConfig()), this.vipLabConfigInit = !0, this.hanleTrackShowWnd()
                })
            }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const o = n(5), a = n(7), s = n(11), l = n(604), c = n(1), u = n(4),
        ...
        let h = class extends o.Vue {
            ...
            onBtnClick() {
                return i(this, void 0, void 0, function* () {
                    do {
                        let e = yield u.client.callServerFunction("GetLoginOption");
                        if (f(e) && f(e.priority) && e.priority > 0) {
                            yield u.client.callServerFunction("OpenNewTab", this.btnUrl);
                            break
                        }
                        e = {tabUrl: this.btnUrl}, yield u.client.callServerFunction("ShowLoginDlg", "vip", !0, e)
                    } while (0);
                    yield u.client.callServerFunction("TrackEvent", "clienttop", "nolog_hover_layer_click", "", 0, 0, 0, 0, ""), null !== this.curWnd && this.curWnd.close()
                })
            }

            trackShowWndEvent() {
                return i(this, void 0, void 0, function* () {
                    yield u.client.callServerFunction("TrackEvent", "clienttop", "nolog_hover_layer_show", "", 0, 0, 0, 0, "")
                })
            }

            mounted() {
                return i(this, void 0, void 0, function* () {
                    this.curWnd = yield a.asyncRemoteCall.getCurrentWindow(), (yield u.client.callServerFunction("IsLogined")) || l.default.getUnloginConfig().then(e => i(this, void 0, void 0, function* () {
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        const r = n(6), i = n(20), o = n(21), a = n(29), s = n(33);
        !function (e) {
            let t;
            !function (e) {
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const i = n(2), o = n(6), a = n(1), s = n(9), l = n(27), c = n(3), u = n(18),
            d = s.default(i.join(__rootDir, "../bin/ThunderHelper.node"));
        let f = "0";
        ...
        h(), v().catch(), "browser" === process.type ? c.ipcMain.on(u.ThunderChannelList.channelRMUpdateLogEnviroment, () => {
        ...
        let s = null;
        const l = n(15), c = n(3), u = n(1), d = n(9), f = n(18), p = n(7), h = "xdas_profile_stat";
        let v = "", m = void 0, g = null, y = void 0, b = null,
            C = d.default(o.join(__rootDir, "../bin/ThunderHelper.node")), w = new Set;
        ...
        function P() {
            return new Promise(e => r(this, void 0, void 0, function* () {
                let t = "";
                t = void 0 === m ? "browser" === process.type ? function () {
                    if (void 0 === m) {
        ...
        function k(e, t, n, i) {
            return r(this, void 0, void 0, function* () {
                ...
                }(S(i)), u = yield R(c), d = `${e}:${s}:${u}`;
                w.has(d) || (w.add(d), l.XLStatNS.trackEvent(h, "uncaught_exception", "", 0, 0, 0, 0, `type=${e},business_name=${yield x()},code=${o},message_hash=${s},message=${encodeURI(a)},stack_hash=${u},stack=${encodeURI(c)}`)), function (e, t, n, i) {
                    return r(this, void 0, void 0, function* () {
                    })
                }().catch()
            })
                        ...
                        (function () {
                            return r(this, void 0, void 0, function* () {
                                do {
                                    ...
                                    l.XLStatNS.trackEvent(h, "page_load_time", "", 0, 0, 0, 0, `start_type=${f},cold_start_up=${e},os_version=${t},load_time=${r},before_fetch_time=${o},domin_lookup_time=${a},connect_time=${s},first_response_time=${c},responseTime=${u},domTime=${d},process=${v}`)
                                } while (0)
                            })
                        })().catch()
                    })
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        const r = n(3), i = n(40), o = n(48), a = n(49), s = n(28), l = n(50), c = n(17), u = r.isPromise,
            d = r.ipcRenderer, f = process.atomBinding("v8_util"), p = new o.default, h = f.createIDWeakMap();
        ...
        function x(e, t, n) {
            const r = {
                value: () => e.value,
                array: () => e.members.map(e => x(e)),
                buffer: () => i.Buffer.from(e.value),
                promise: () => Promise.resolve({then: x(e.then)}),
                error: () => (function (e) {
            ...
            return e.type in r ? o = r[e.type]() : e.refId ? h.has(e.refId) ? o = h.get(e.refId) : (c.warn("[metaToValue] refId point to null" + e.refId), o = "function" === e.type ? () => {
            } : {}) : e.id ? h.has(e.id) ? (y(o = h.get(e.id), e.id, e.members, !0), b(o, e.id, e.proto)) : (o = "function" === e.type ? t ? function (e, t, n) {
                if (h.has(n.id)) return h.get(n.id);
                let r = w(e), i = function (...e) {
                ...
                let o = new Proxy(i, {
                    apply: (e, n, i) => new Promise((e, o) => {
                        ...
                        let u = s.default.browser.memberCall, f = l.default(u), p = m(i);
                        d.send(u, f, c, r, t, p), a.default.add(f, t => {
                            try {
                                g(x(t), e, o)
                            } catch (e) {
                                o(e)
                        ...
                        d.send(o, c, r, t, m(n)), a.default.add(c, t => {
                            try {
                                let n = x(t);
                                e(n)
                            } catch (e) {
                ...
                return C(n, t), new Proxy(n, {
                    apply: (e, n, r) => new Promise((e, i) => {
                        let o = s.default.browser.functionCall, c = l.default(o), u = w(n);
                        d.send(o, c, u, t, m(r)), a.default.add(c, t => {
                            try {
                                g(x(t), e, i)
                            } catch (e) {
                                i(e)
                        ...
                        d.send(i, o, t, m(n)), a.default.add(o, t => {
                            try {
                                let n = x(t);
                                e(n)
                            } catch (e) {
                ...
                Object.defineProperties(e, {
                    __set: {
                        enumerable: !1, writable: !1, value: function (n, r) {
                            ...
                            return new Promise((i, o) => {
                                let c = s.default.browser.memberSet, u = l.default(c), f = m([r]);
                                d.send(c, u, t, n, f), a.default.add(u, t => {
                                    try {
                                        let a = x(t);
                                        e[n] = r, i(a)
                                    } catch (e) {
                        ...
                        enumerable: !1, writable: !1, value: function (n) {
                            return new Promise((r, i) => {
                                ...
                                d.send(o, c, t, n), a.default.add(c, t => {
                                    try {
                                        const o = x(t);
                                        e[n] = o, r(o)
                                    } catch (e) {
                        ...
                        enumerable: !1, writable: !1, value: function () {
                            return new Promise((e, n) => {
                                ...
                                d.send(r, i, t), a.default.add(i, r => {
                                    try {
            ...
            }(o), y(o, e.id, e.members), b(o, e.id, e.proto), Object.defineProperty(o.constructor, "name", {value: e.name}), e.extendedMemberNames && e.extendedMemberNames.forEach((e, t) => {
            ...
            constructor(...e) {
                if (this.__resolved_ = !1, this.__promise_ = null, this.__remoteObj_ = null, this.__what_ = "", this.__name_ = "", "string" === typeof arguments[0]) {
                    ...
                    this.__what_ = e, this.__name_ = t || e, this.__resolved_ = !1, this.__remoteObj_ = null, this.__promise_ = new Promise((n, r) => {
                        ...
                        d.send(i, o, t), a.default.add(o, e => {
                            try {
                                let t = x(e);
        ...
        d.on(s.default.renderer.requireReturn, T), d.on(s.default.renderer.getBuiltInReturn, T), d.on(s.default.renderer.getGlobalReturn, T), d.on(s.default.renderer.currentWindowReturn, T), d.on(s.default.renderer.currentWebContentsReturn, T), d.on(s.default.renderer.functionCallReturn, T), d.on(s.default.renderer.constructReturn, T), d.on(s.default.renderer.memberCallReturn, T), d.on(s.default.renderer.memberSetReturn, T), d.on(s.default.renderer.memberGetReturn, T), d.on(s.default.renderer.memberConstructReturn, T), d.on(s.default.renderer.callback, (e, t, n) => {
            p.apply(t, x(n))
        }), d.on(s.default.renderer.syncReturn, T), d.on("ELECTRON_RENDERER_RELEASE_CALLBACK", (e, t) => {
            c.info("[RELEASE_CALLBACK]: callbackId:", t), p.remove(t)
        }), process.on("exit", () => {
            d.send(s.default.browser.contextRelease)
        });
        const R = ["__resolve", "__isResolved"],
            P = ["__promise_", "__resolved_", "__remoteObj_", "__name_", "__what_"], k = e => {
        ...
        function O(e) {
            ...
            let n = new Proxy(t, {
                ...
                defineProperty: (t, n, r) => (k(e), Reflect.defineProperty(e.__remoteObj_, n, r)),
                get: (t, n, r) => {
                    if ("string" == typeof n) {
                ...
                set: (t, n, r, i) => (k(e), Reflect.set(e.__remoteObj_, n, r, i)),
                ownKeys: t => (k(e), Reflect.ownKeys(e.__remoteObj_)),
                apply: (t, n, r) => {
                    k(e), Reflect.apply(e.__remoteObj_, n, r)
                },
                construct: (t, n, r) => {
                    ...
                    return new Promise((t, r) => {
                        ...
                        d.send(i, o, c, m(n)), a.default.add(o, e => {
                            try {
                                t(x(e))
                            } catch (e) {
                                r(e)
        ...
        t.remoteRequire = function (e) {
            return O(new S("module", e))
        }, t.getBuiltin = function (e) {
            return O(new S("builtin", e))
        }, t.getGlobal = function (e) {
            return O(new S("global", e))
        }, t.getCurrentWindow = function () {
            return O(new S("current_window"))
        }, t.getCurrentWebContents = function () {
            return O(new S("current_web_contents"))
        }
    }, 48: function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        ...
        function p(e, t, n, r, i, o) {
            ...
            do {
                ...
                if (l) try {
                    a = n.value[r], l = !1, n.meta.extendedMemberNames.push(r), u = !0
                } catch (e) {
                ...
                c = {
                    ...
                    writable: !1,
                    type: "get"
                }, void 0 === i.get && "function" == typeof a ? c.type = "method" : ((i.set || i.writable) && (c.writable = !0), c.type = "get"), u ? (c.configurable = !0, c.value = m(e, a, o, !1, null)) : c.value = m(e, a, o, !1, n)
            } while (0);
            return c
        }
        ...
        function v(e, t, n, r = null) {
            ...
            return i = null === o || o === Object.prototype || o === Function.prototype ? null : m(e, o, r, !1, n)
        }

        function m(e, t, n = null, r = !1, i = null) {
            n = null === n ? {} : n;
            ...
            do {
                ...
                "array" === o.type ? o.members = t.map(t => m(e, t, n)) : "object" === o.type || "function" === o.type ? (null == i && (o.extendedMemberNames = [], i = {
                    value: t,
                    meta: o
                }), o.name = t.constructor ? t.constructor.name : "", o.id = f.add(e, t), n[o.id] = !0, o.members = h(e, t, i, n), o.proto = v(e, t, i, n)) : "buffer" === o.type ? o.value = Buffer.from(t) : "promise" === o.type ? (t.then(function () {
                }, function () {
                }), o.then = m(e, function (e, n) {
                    t.then(e, n)
            ...
            const n = function (t) {
                ...
                switch (t.type) {
                    ...
                    case"function": {
                        ...
                        if (s.info("renderer function id:" + i), d.has(i)) return d.get(i);
                        let a = function (...i) {
                            ...
                            e.isDestroyed() || n !== e.id ? function (e, t, n) {
                                ...
                                s.warn(i)
                            }(t, l, a) : e.send(o.default.renderer.callback, t.id, m(e, l))
                        };
                        return Object.defineProperty(a, "length", {value: t.length}), u.setRemoteCallbackFreer(a, t.id, e), d.set(i, a), a
                    }
                    default:
        ...
        !function (e) {
            ...
            e.startServer = function () {
                c.on(o.default.browser.require, (e, n, r) => {
                    ...
                    let i, a = global[r];
                    i = m(e.sender, a), s.info(`[GLOBAL]: returns remoteid=${i.id}, obj=` + typeof a), t(e, o.default.renderer.getGlobalReturn, n, i)
                }), c.on(o.default.browser.currentWindow, (e, n, r) => {
                    s.info(`[CURRENT_WINDOW]: property=${r} `);
                    let i = e.sender.getOwnerBrowserWindow.call(e.sender), a = m(e.sender, i);
                    ...
                    t(e, o.default.renderer.currentWebContentsReturn, n, m(e.sender, e.sender))
                });
                const e = (e, t) => {
                    const n = (t, n) => {
                ...
                c.on(o.default.browser.construct, (n, r, i, a) => {
                    ...
                    try {
                        ...
                        let u = a.length > 0 ? a[a.length - 1] : null;
                        a = y(n.sender, a);
                        let d = f.get(i);
                        null == d && w(`Cannot call constructor on missing remote object ${i}`), u && "interest" === u.type && (c = a.pop());
                        let p = new (Function.prototype.bind.apply(d, [null].concat(a)));
                        p && c && e(p, c), l = m(n.sender, p, null, !1), s.info(`[CONSTRUCTOR]: returns remoteId =${l.id} name=${d.name} `)
                    } catch (e) {
                        l = C(e)
                    } finally {
                    ...
                    let l;
                    try {
                        s.info(`[FUNCTION_CALL]: remoteId=${i}`), a = y(e.sender, a);
                        let c = f.get(i);
                        if (null == c) s.error(`Cannot call function on missing remote object ${i}`), l = m(e.sender, void 0); else {
                            let t = r ? f.get(r) : global;
                            if (t) {
                                let n = b(0, c, t, a);
                                l = m(e.sender, n)
                            } else s.error(`Cannot call function(${i}) on missing context(${r})`), l = m(e.sender, void 0)
                        }
                    ...
                    try {
                        l = y(e.sender, l);
                        let u = f.get(i);
                        null == u && w(`Cannot call function '${a}' on missing remote object ${i}`);
                        let d = r ? f.get(r) : u;
                        if (d) {
                            let t = b(0, u[a], d, l);
                            c = m(e.sender, t), s.info("[MEMBER_CALL]: return=" + t)
                    ...
                    try {
                        ...
                        let l = f.get(r);
                        null == l && w(`Cannot get property '${Object.toString.call(i)}' on missing remote object ${r}`);
                        let c = l[i];
                        a = m(e.sender, c)
                    } catch (e) {
                        a = C(e)
                    ...
                    try {
                        s.info(`[MEMBER_SET]: remoteId=${r}, property=` + i), a = y(e.sender, a);
                        let l = f.get(r);
                        null == l && w(`Cannot set property '${Object.toString.call(i)}' on missing remote object ${r}`), l[i] = a[0], t(e, o.default.renderer.memberSetReturn, n, {
                            type: "value",
                            value: !0
                        })
                    } catch (r) {
                        t(e, o.default.renderer.memberSetReturn, n, C(r))
                    }
                    ...
                    try {
                        ...
                        l = y(n.sender, l);
                        let p = f.get(i);
                        null == p && w(`Cannot call constructor '${a}' on missing remote object ${i}`), d && "interest" === d.type && (u = l.pop());
                        let h = p[a], v = new (Function.prototype.bind.apply(h, [null].concat(l)));
                        v && u && e(v, u), c = m(n.sender, v)
                    } catch (e) {
                        c = C(e)
                    } finally {
                    ...
                    let i = f.get(r);
                    t(e, o.default.renderer.syncReturn, n, m(e.sender, i))
        ...
        function c(e) {
            if (l) if (e.type === i.SkinHelperNS.SkinType.Default) document.body.classList.remove("is-theme"), a.ThunderUtil.setCSSProperties(document.body, {
                ...
                let {colors: {colorPrimary: t, colorPrimaryControl1: n, colorPrimaryControl2: r, colorPrimaryControl3: i, colorPrimaryControl4: o, colorPrimaryGradient: s, colorPrimaryText: l, colorSearch: c, colorSecondary: u, colorGradientBackground: d, colorGradientForeground: f, colorAccordion: p}, opacity: h} = e;
        ...
        const a = ".xv;.xlmv;.3gp;.3gp2;.3gpp;.3gpp2;.3mm;.3p2;.60d;.787;.aaf;.aep;.aepx;.aet;.aetx;.ajp;.ale;.amv;.amx;.arf;\n  .asf;.asx;.avb;.avd;.avi;.avp;.avs;.avs;.axm;.bdm;.bdmv;.bik;.bix;.bmk;.bnp;.box;.bs4;.bsf;.byu;.camproj;.camrec;.clpi;.cmmp;\n  .cmmtpl;.cmproj;.cmrec;.cpi;.cst;.cvc;.d2v;.d3v;.dat;.dav;.dce;.dck;.ddat;.dif;.dir;.divx;.dlx; .dmb;.dmsm;.dmsm3d;.dmss;.dnc;.dpg;\n  .dream;.dsy;.dv;.dv-avi;.dv4;.dvdmedia;.dvr-ms;.dvx;.dxr;.dzm;.dzp;.dzt;.edl;.evo;.eye;.f4p;.f4v;.fbr;.fbr;.fbz;.fcp;.flc;.flh;\n  .fli;.flv;.flx;.gfp;.gl;.grasp;.gts;.gvi;.gvp;.hdmov;.hkm;.ifo;.imovieproj;.imovieproject;.iva;.ivf;.ivr;.ivs;.izz;.izzy;.jts;.jtv;\n  .k3g;.lrec;.lsf;.lsx;.m15;.m1pg;.m1v;.m21;.m21;.m2a;.m2p;.m2t;.m2ts;.m2v;.m4e;.m4u;.m4v;.m75;.meta;.mgv;.mj2;.mjp;.mjpg;.mkv;.mmv;\n  .mnv;.mod;.modd;.moff;.moi;.moov;.mov;.movie;.mp21;.mp2v;.mp4;.mp4v;.mpe;.mpeg;.mpeg4;.mpf;.mpg;.mpg2;.mpgindex;.mpl;.mpls;\n  .mpsub;.mpv;.mpv2;.mqv;.msdvd;.msh;.mswmm;.mts;.mtv;.mvb;.mvc;.mvd;.mve;.mvp;.mvy;.mxf;.mys;.ncor;.nsv;.nuv;.nvc;.ogm;.ogv;.ogx;.osp;\n  .par;.pds;.pgi;.piv;.pjs;.pmf;.pns;.ppj;.prel;.pro;.prproj;.prtl;.psh;.pssd;.pva;.pvr;.pxv;.qt;.qtch;.qtl;.qtm;.qtz;\n  .r3d;.rcproject;.rdb;.rec;.rm;.rmd;.rmp;.rms;.rmvb;.roq;.rp;.rts;.rts;.rum;.rv;.sbk;.sbt;.scc;.scm;.scn;.screenflow;.sec;.seq;.sfd;\n  .sfvidcap;.smk;.sml;.smv;.spl;.ssm;.stl;.str;.stx;.svi;.swf;.swi;.swt;.tda3mt;.tivo;.tix;.tod;.tp;.tp0;.tpd;\n  .tpr;.trp;.ts;.tts;.tvs;.vc1;.vcpf;.vcr;.vcv;.vdo;.vdr;.veg;.vem;.vf;.vfw;.vfz;.vgz;.vid;.viewlet;.viv;.vivo;.vlab;.vob;.vp3;.vp6;.vp7;\n  .vro;.vs4;.vse;.vsp;.w32;.wcp;.webm;.wlmp;.wm;.wmd;.wmmp;.wmv;.wmx;.wp3;.wpl;.wtv;.wvx;.xfl;.xvid;.yuv;.zm1;.zm2;.zm3;.zmv;",
            ...
            v = ".exe;.com;.bat;.msi", m = ".wav;.flac;.mp3;.aac;.wma;.m4a;.mid;.ape;.ogg;.ra;.mod",
            ...
            C = ".asf;.mpg;.rmvb;.rm;.wmv;.avi;.mp4;.mpeg;.mkv;.mov;.ts;.flv;.3gp;",
        ...
        !function (e) {
            ...
            function n(e) {
                ...
                return null !== i && void 0 !== i && i.length >= 2 && (i = i.toLowerCase()), void 0 === i || "" === i || i.length < 2 ? n = t.Unkown : h.indexOf(i) > -1 ? n = t.Video : v.indexOf(i) > -1 ? n = t.Software : y.indexOf(i) > -1 ? n = t.Doc : m.indexOf(i) > -1 ? n = t.Music : g.indexOf(i) > -1 ? n = t.Pic : b.indexOf(i) > -1 && (n = t.Zip), i.length > 1 && ".z" === i.slice(0, 2) && /[0-9]+/.test(i.substring(2)) && (n = t.Zip), n
            }
            ...
            e.getTaskIcon = function (e, t, n) {
                ...
                do {
                    ...
                    let v = (n = n.toLowerCase()).substring(1);
                    if (o.indexOf(v) > -1) {
                        h = "doc" === n ? "word" : v;
                        break
                    }
                ...
                let i = t.Unkown;
                return void 0 === n && void 0 !== e && (n = r.extname(e)), null !== n && void 0 !== n && n.length >= 2 && (n = n.toLowerCase(), n += ";"), void 0 === n || "" === n || n.length < 3 ? i = t.Unkown : a.indexOf(n) > -1 ? i = t.Video : s.indexOf(n) > -1 ? i = t.Software : l.indexOf(n) > -1 ? i = t.Doc : c.indexOf(n) > -1 ? i = t.Music : u.indexOf(n) > -1 ? i = t.Pic : d.indexOf(n) > -1 ? i = t.Zip : f.indexOf(n) > -1 && (i = t.Bt), n.length > 1 && ".z" === n.slice(0, 2) && /[0-9]+/.test(n.substring(2)) && (i = t.Zip), i
                ...
                do {
                    ...
                    let r = 0, i = 0, o = 0, a = 0, s = 0, l = 0, c = 0, u = 0, d = e.split(/\./);
                    if (null === d || void 0 === d || d.length < 3) break;
                    if (r = Number(d[0]), i = Number(d[1]), o = Number(d[2]), null !== d[3] && void 0 !== d[3] && "" !== d[3] && (a = Number(d[3])), null === (d = t.split(/\./)) || void 0 === d || d.length < 3) break;
                    if (s = Number(d[0]), l = Number(d[1]), c = Number(d[2]), null !== d[3] && void 0 !== d[3] && "" !== d[3] && (u = Number(d[3])), s > r) {
                        n = 1;
                        break
                    }
                    if (s < r) {
        ...
        (function (e) {
            var n = 200, r = "__lodash_hash_undefined__", i = 800, o = 16, a = 9007199254740991,
                ...
                h = "[object Undefined]", v = /^\[object .+?Constructor\]$/, m = /^(?:0|[1-9]\d*)$/, g = {};
            g["[object Float32Array]"] = g["[object Float64Array]"] = g["[object Int8Array]"] = g["[object Int16Array]"] = g["[object Int32Array]"] = g["[object Uint8Array]"] = g["[object Uint8ClampedArray]"] = g["[object Uint16Array]"] = g["[object Uint32Array]"] = !0, g[s] = g["[object Array]"] = g["[object ArrayBuffer]"] = g["[object Boolean]"] = g["[object DataView]"] = g["[object Date]"] = g["[object Error]"] = g[c] = g["[object Map]"] = g["[object Number]"] = g[f] = g["[object RegExp]"] = g["[object Set]"] = g["[object String]"] = g["[object WeakMap]"] = !1;
            var y = "object" == typeof global && global && global.Object === Object && global,
                b = "object" == typeof self && self && self.Object === Object && self,
                C = y || b || Function("return this")(), w = "object" == typeof t && t && !t.nodeType && t,
                x = w && "object" == typeof e && e && !e.nodeType && e, S = x && x.exports === w, T = S && y.process,
                R = function () {
                    try {
            ...
            var k, O, E, D = Array.prototype, N = Function.prototype, M = Object.prototype, L = C["__core-js_shared__"],
                F = N.toString, A = M.hasOwnProperty,
                j = (k = /[^.]+$/.exec(L && L.keys && L.keys.IE_PROTO || "")) ? "Symbol(src)_1." + k : "",
                _ = M.toString, I = F.call(Object),
                W = RegExp("^" + F.call(A).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                z = S ? C.Buffer : void 0, B = C.Symbol, V = C.Uint8Array, U = z ? z.allocUnsafe : void 0,
                G = (O = Object.getPrototypeOf, E = Object, function (e) {
                    return O(E(e))
                }), H = Object.create, q = M.propertyIsEnumerable, X = D.splice, Y = B ? B.toStringTag : void 0,
                Z = function () {
                    try {
                ...
                }(), K = z ? z.isBuffer : void 0, J = Math.max, Q = Date.now, $ = Ce(C, "Map"),
                ee = Ce(Object, "create"), te = function () {
                    function e() {
                    }
            ...
            function ae(e, t) {
                var n = ke(e), r = !n && Pe(e), i = !n && !r && Ee(e), o = !n && !r && !i && Fe(e),
                    a = n || r || i || o, s = a ? function (e, t) {
                        for (var n = -1, r = Array(e); ++n < e;) r[n] = t(n);
                        return r
                    }(e.length, String) : [], l = s.length;
                for (var c in e) !t && !A.call(e, c) || a && ("length" == c || i && ("offset" == c || "parent" == c) || o && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || we(c, l)) || s.push(c);
                return s
            }

            function se(e, t, n) {
                (void 0 === n || Re(e[t], n)) && (void 0 !== n || t in e) || ue(e, t, n)
            }

            function le(e, t, n) {
                var r = e[t];
                A.call(e, t) && Re(r, n) && (void 0 !== n || t in e) || ue(e, t, n)
            }
            ...
            ne.prototype.clear = function () {
                ...
                this.size = 0, this.__data__ = {hash: new ne, map: new ($ || re), string: new ne}
                ...
                if (r instanceof re) {
                    var i = r.__data__;
                    if (!$ || i.length < n - 1) return i.push([e, t]), this.size = ++r.size, this;
                    r = this.__data__ = new ie(i)
                }
            ...
            function pe(e) {
                return null == e ? void 0 === e ? h : d : Y && Y in Object(e) ? function (e) {
                    var t = A.call(e, Y), n = e[Y];
                    try {
                        e[Y] = void 0;
                        var r = !0
                    } catch (e) {
            ...
            function ve(e) {
                return !(!Me(e) || j && j in e) && (De(e) ? W : v).test(function (e) {
                    if (null != e) {
                        try {
                            return F.call(e)
                        } catch (e) {
            ...
            function ge(e, t, n, r, i) {
                e !== t && fe(t, function (o, a) {
                    if (i || (i = new oe), Me(o)) !function (e, t, n, r, i, o, a) {
                        var s = Se(e, n), l = Se(t, n), c = a.get(l);
                        if (c) return void se(e, n, c);
                        var u = o ? o(s, l, n + "", e, t, a) : void 0, d = void 0 === u;
                        if (d) {
                            var p = ke(l), h = !p && Ee(l), v = !p && !h && Fe(l);
                            u = l, p || h || v ? ke(s) ? u = s : Le(C = s) && Oe(C) ? u = function (e, t) {
                                var n = -1, r = e.length;
                                t || (t = Array(r));
                                for (; ++n < r;) t[n] = e[n];
                                return t
                            }(s) : h ? (d = !1, u = function (e, t) {
                                if (t) return e.slice();
                                var n = e.length, r = U ? U(n) : new e.constructor(n);
                                return e.copy(r), r
                            }(l, !0)) : v ? (d = !1, m = l, g = !0 ? (y = m.buffer, b = new y.constructor(y.byteLength), new V(b).set(new V(y)), b) : m.buffer, u = new m.constructor(g, m.byteOffset, m.length)) : u = [] : function (e) {
                                if (!Le(e) || pe(e) != f) return !1;
                                var t = G(e);
                                if (null === t) return !0;
                                var n = A.call(t, "constructor") && t.constructor;
                                return "function" == typeof n && n instanceof n && F.call(n) == I
                            }(l) || Pe(l) ? (u = s, Pe(s) ? u = function (e) {
                                return function (e, t, n, r) {
                                    ...
                                    for (; ++o < a;) {
                                        ...
                                        void 0 === l && (l = e[s]), i ? ue(n, s, l) : le(n, s, l)
                                    }
                                    return n
                                }(e, Ae(e))
                            }(s) : Me(s) && !De(s) || (u = function (e) {
                                return "function" != typeof e.constructor || xe(e) ? {} : te(G(e))
                            }(l))) : d = !1
                        }
                        var m, g, y, b;
                        var C;
                        ...
                        var s = r ? r(Se(e, a), o, a + "", e, t, i) : void 0;
                        void 0 === s && (s = o), se(e, a, s)
                    }
                }, Ae)
            }
            ...
            function ye(e, t) {
                return Te(function (e, t, n) {
                    return t = J(void 0 === t ? e.length - 1 : t, 0), function () {
                        for (var r = arguments, i = -1, o = J(r.length - t, 0), a = Array(o); ++i < o;) a[i] = r[t + i];
                        i = -1;
            ...
            var Pe = he(function () {
                ...
                return Le(e) && A.call(e, "callee") && !q.call(e, "callee")
            }, ke = Array.isArray;

            function Oe(e) {
                return null != e && Ne(e.length) && !De(e)
            }
            ...
            var Fe = P ? function (e) {
                ...
                return Le(e) && Ne(e.length) && !!g[pe(e)]
            };

            function Ae(e) {
                return Oe(e) ? ae(e, !0) : me(e)
            }

            var je, _e = (je = function (e, t, n) {
                ge(e, t, n)
            }, ye(function (e, t) {
                var n = -1, r = t.length, i = r > 1 ? t[r - 1] : void 0, o = r > 2 ? t[2] : void 0;
                for (i = je.length > 3 && "function" == typeof i ? (r--, i) : void 0, o && function (e, t, n) {
                    if (!Me(n)) return !1;
                    var r = typeof t;
                    return !!("number" == r ? Oe(n) && we(t, n.length) : "string" == r && t in n) && Re(n[t], e)
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const i = n(39), o = n(680), a = n(1), s = n(11), l = n(4), c = n(13), u = n(36), d = n(14);
        let {isDef: f, isUndef: p} = s.ThunderUtil;
        const h = a.default.getLogger("personalInfo:config-manager"), v = o.VipConfigDefineNS.cacheDir,
            m = `${v}/vip-config.json`;
        t.default = new class {
            constructor() {
                this.isGettingConfig = !1, this.eventEmitter = new d.EventEmitter, this.init().catch()
            }
            ...
            getLoginConfig() {
                return r(this, void 0, void 0, function* () {
                    let e = null, t = yield this.getConfigs();
                    return f(t) && (e = t.loginCommon), {common: e}
                })
            }
            ...
            getConfigs() {
                return r(this, void 0, void 0, function* () {
                    let e = null;
                    return e = f(this.configs) ? this.configs : new Promise(e => r(this, void 0, void 0, function* () {
                ...
                return r(this, void 0, void 0, function* () {
                    ...
                    do {
                        try {
                            ...
                            h.warning("解析本地配置信息失败")
                        }
                        if (f(e) && e.date === (new Date).toLocaleDateString()) break;
                        const t = "http://images.client.vip.xunlei.com/xlx/hover/hover.js";
                        h.information("readConfigs", "url", t);
                        try {
                            i.default.defaults.adapter = n(25);
                            let r = yield i.default.get(t, {timeout: 1e3});
                            h.information("getConfigs res", r), 200 === r.status && f(r.data) && r.data instanceof Object && ((e = r.data).date = (new Date).toLocaleDateString(), yield c.FileSystemAWNS.writeFileAW(m, JSON.stringify(e)))
                        } catch (e) {
                            h.warning(e)
                        }
                    } while (0);
                ...
                return r(this, void 0, void 0, function* () {
                    ...
                    if (e >= 0 && e < 16) ; else {
                        do {
                            ...
                            if (h.information("peerid", t), f(t) && t.length > 0) try {
                                const n = u.createHash("sha256");
                                n.update(t);
                                let r = n.digest("hex");
                                h.information("strHash", r), e = parseInt(r[r.length - 1], 16)
                            } catch (e) {
                                h.warning("err", e)
                            }
                            if (f(e) && e >= 0 && e < 16) break;
        ...
        "use strict";
        var r = n(10), i = n(109), o = {"Content-Type": "application/x-www-form-urlencoded"};
        ...
        var s, l = {
            adapter: ("undefined" != typeof XMLHttpRequest ? s = n(110) : "undefined" != typeof process && (s = n(25)), s),
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const i = n(7), o = n(1), a = n(11), s = n(59), l = o.default.getLogger("MenuSkinNS");
        !function (e) {
            function t(e, t) {
                return r(this, void 0, void 0, function* () {
                    if (l.information("setStyle", e, t), null !== e) {
                        const {WindowPreferenceNS: r} = yield Promise.resolve().then(() => n(60));
                        let i = {windowPreference: r.getWindowPreference()};
                        l.information("skinOpts", i), yield e.setStyle(s(i, t))
                    }
                })
            }
            ...
            e.setStyle = t, e.popEditableDefaultContextMenu = function (e, n, o) {
                return r(this, void 0, void 0, function* () {
                    let o = yield i.asyncRemoteCall.getCurrentWebContents();
                    o.once("context-menu", (s, c) => r(this, void 0, void 0, function* () {
                        if (l.verbose(s), c.isEditable) {
                            ...
                            let s = yield(yield i.asyncRemoteCall.getMenu()).buildFromTemplate(r);
                            yield t(s, {});
                            let l = yield i.asyncRemoteCall.getCurrentWindow();
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const i = n(39), o = n(1), a = n(4), s = n(11), l = n(14);
        ...
        !function (e) {
            ...
            e.getCardCount = function () {
                return r(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        u.information("getCardCount", "url", s), i.default.defaults.adapter = n(25);
                ...
                return r(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        u.information("getSignCoin", "url", s), i.default.defaults.adapter = n(25);
                        let l = yield i.default.get(s, {params: {userid: t, sessionid: r}, timeout: o});
            ...
            e.getIsUsedToBeVip = function () {
                return r(this, void 0, void 0, function* () {
                    let e = null;
                    return e = c(d) ? d : new Promise(e => r(this, void 0, void 0, function* () {
                        s ? t.once("OnGetUsedToBeVip", t => {
                            e(t)
                        }) : (s = !0, d = yield function () {
                            return r(this, void 0, void 0, function* () {
                                let e = !1;
                                try {
                                    const t = yield a.client.callServerFunction("GetUserID"),
                                    ...
                                    u.information("isUsedToBeVip", "url", r);
                                    ...
                                    if (u.information("isUsedToBeVip res", s), 200 === s.status && c(s.data) && 1 === s.data.code && c(s.data.result)) {
                        ...
                        }(), u.information("getIsUsedToBeVip", d), s = !1, t.emit("OnGetUsedToBeVip", d), e(d))
                    }))
                })
                ...
                return r(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        u.information("isContinueMonthPayVip", "url", s);
                        ...
                        u.information("isContinueMonthPayVip res", l), 200 === l.status && c(l.data) && 1 === l.data.code && c(l.data.result) && (t = e ? 1 === Number(l.data.result.autoRenew) : 1 === Number(l.data.result.isSign))
                    } catch (e) {
                        u.warning(e)
                    }
                    return t
                ...
                return r(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        u.information("isNewUserWithout res", s), 200 === s.status && c(s.data) && 0 === s.data.result && c(s.data.data) && (e = 0 === Number(s.data.data.hasTaskPrize))
                    } catch (e) {
                        u.warning(e)
                    }
                    return e
                ...
                return r(this, void 0, void 0, function* () {
                    try {
                        ...
                        u.information("getUserFund", "url", n);
                        let r = "sessionid=" + t + ";userid=" + e,
                            s = yield i.default.get(n, {headers: {cookie: r}, timeout: o});
                        if (u.information("getUserFund res", s), 200 === s.status && c(s.data) && 0 === s.data.result && c(s.data.data)) {
                            let e = s.data.data;
        ...
        !function (e) {
            ...
            e.init = function () {
                return r(this, void 0, void 0, function* () {
                    if (o = new a.EventEmitter, c = i.client.attachServerEvent("SyncEvent", (e, i) => r(this, void 0, void 0, function* () {
                        let r = null;
                        try {
                            r = JSON.parse(i)
                        } catch (e) {
                ...
                o.removeAllListeners(), c && (i.client.detachServerEvent("SyncEvent", c), c = void 0), l && (clearInterval(l), l = null)
            }, e.checkSyncMsg = u, e.getSyncMsgState = function () {
                return n
            }, e.syncIsConnected = d, e.attachSyncMsgStateChangeEvent = function (e) {
                return o.addListener("SyncMsgStateChange", e), e
            }, e.detachSyncMsgStateChangeEvent = function (e) {
                o.removeListener("SyncMsgStateChange", e)
            }
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        const i = n(4), o = n(38), a = n(1), s = n(39), l = n(138), c = a.default.getLogger("vip-label-config");
        !function (e) {
            ...
            e.getConfig = function (e) {
                return r(this, void 0, void 0, function* () {
                    ...
                    return t || (t = yield function (e) {
                        return r(this, void 0, void 0, function* () {
                            let t = yield u(), o = yield function () {
                                    return r(this, void 0, void 0, function* () {
                                        if (!n) {
                                            let e = 0, t = yield u(), r = t.split(".");
                                            if (r && 3 === r.length) {
                                ...
                                d = yield i.client.callServerFunction("GetTpPeerId"), f = "",
                                p = yield i.client.callServerFunction("GetUserID");
                            if ("0" !== p) {
                                let e = yield i.client.callServerFunction("GetSessionID");
                                f = `http://advertpay.vip.xunlei.com/xlx/advertisement?iver=${o}&over=${t}&userid=${p}&sessionid=${e}&scene=${a}&deviceid=${l}&cpeerid=${d}&timestamp=${Date.now()}`
                            } else f = `http://advertpay.vip.xunlei.com/xlx/advertisement?iver=${o}&over=${t}&scene=${a}&deviceid=${l}&cpeerid=${d}&timestamp=${Date.now()}`;
        ...
        var r = n(34), i = n(54), o = n(63), a = n(98), s = n(76).Writable, l = n(115)("follow-redirects"),
        ...
        function f(e) {
            ...
            return Object.keys(e).forEach(function (i) {
                ...
                c.request = function (e, i) {
                    ...
                    }, e), e.nativeProtocols = n, a.equal(e.protocol, o, "protocol mismatch"), l("options", e), new d(e, i)
                }, c.get = function (e, t) {
                    var n = c.request(e, t);
                    return n.end(), n
                }
        ...
        ["abort", "aborted", "error", "socket", "timeout"].forEach(function (e) {
        ...
        }), d.prototype = Object.create(s.prototype), d.prototype.write = function (e, t, n) {
            ...
            for (var o in this._currentUrl = r.format(this._options), i._redirectable = this, u) o && i.on(o, u[o]);
            if (this._isRedirect) {
